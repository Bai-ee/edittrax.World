(function() {
    ...
    function Creative(dmo){
        ...
        function init(wrapperID) {
            var subdirectory = "155412_OPS_MBL";
        ...
        function createElements(){
	        ...
	        var landingPage = "https://www.fortworth.com" /*+ Math.floor(Math.random() * 100000000000)*/;
...
/////////////////////////////	
			...
			/* [CREATING_COMPONENTS] */
			var catImgVarsArr = [
					R.create("var").set({name:"cat_img1", defaultValue:"155412OPS_INT_FortWorth_F2_320x480.jpg", dataType:"String", required:true, exposed:true}).render().value(),
					R.create("var").set({name:"cat_img2", defaultValue:"155412OPS_INT_FortWorth_F3_320x480.jpg", dataType:"String", required:false, exposed:true}).render().value(),
					R.create("var").set({name:"cat_img3", defaultValue:"155412OPS_INT_FortWorth_F_320x480.jpg", dataType:"String", required:false, exposed:true}).render().value(),
					R.create("var").set({name:"cat_img4", defaultValue:"155412OPS_INT_FortWorth_F5_320x480.jpg", dataType:"String", required:false, exposed:true}).render().value()
				];
			var catImgsArr = [];
			var catImgUrlArr = [];
			...
			for (var i = 0; i < catImgVarsArr.length; i++) {
				...
				var clickTracker = window.conversant.mobile.clickTag;
				var clickArray = ["https://www.fortworth.com/things-to-do/western-experience", "https://www.fortworth.com/music", "https://www.fortworth.com/restaurants", "https://www.fortworth.com/things-to-do/museums-and-galleries"]
            ...
            function animateElements() {
				...
				openingAnimation();
            	 ...
            	 arrayOfSelectionImages.forEach(function(el){
            		 ...
            		 icon1_text_img.on("click", clickToRotator);
            		 icon2_text_img.on("click", clickToRotator);
            		 icon3_text_img.on("click", clickToRotator);
            		 icon4_text_img.on("click", clickToRotator);
            	 })
