(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:809,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:809, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:809, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:809, pointerEvents:"none", parentNode:stage}).render()
            };
...
///////////////////////////////////////////////////
			...
			var headline_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"headline_text_font_size", defaultValue:"32", dataType:"String", required:false, exposed:true}).render().value(),
					...
					letterSpacing: R.create("var").set({name:"headline_text_tracking", defaultValue:"0.8", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "center",
			...
			var subhead_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"subhead_text_font_size", defaultValue:"13", dataType:"String", required:false, exposed:true}).render().value(),
					...
					fontStyle: "Light",
					lineHeight: R.create("var").set({name:"subhead_text_line_height", defaultValue:"1.31", dataType:"String", required:false, exposed:true}).render().value(),
					letterSpacing: R.create("var").set({name:"subhead_text_tracking", defaultValue:"0.325", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "center",
					verticalAlign: "middle",
					marginTop: 6,
			...
			var cta_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"cta_text_font_size", defaultValue:"12", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var details_text = R.create("div").set({
				css:{
					...
					fontStyle: "Light",
					lineHeight: R.create("var").set({name:"details_text_line_height", defaultValue:"1.22", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var badge_text = R.create("div").set({
				css:{
					...
					fontStyle: "RomanFamily",
					lineHeight: R.create("var").set({name:"badge_text_line_height", defaultValue:"1", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var legal_close = R.create("div").set({
				...
				css: {
					...
					cursor: "pointer",
					position: "absolute",
					color: R.create("var").set({name:"legal_close_text_color", defaultValue:"#ffffff", dataType:"Color", required:false, exposed:true}).render().value(),
					textAlign: "left"
				},
				rosetta: {
					parentNode: legalTextContainer
			...
			var legal_text = R.create("div").set({
				...
				css: {
					fontSize: R.create("var").set({name:"legal_text_font_size", defaultValue:"12", dataType:"Number", required:false, exposed:true}).render().value(),
					minFontSize: R.create("var").set({name:"legal_text_font_size", defaultValue:"12", dataType:"Number", required:false, exposed:true}).render().value(),
			...
			var group2Array = [headline_text, subhead_text, cta_text, details_text];
            ...
            // All Animation goes here
                ...
                var frame_1_in = new TimelineMax()
					...
					if(subhead_text.element){frame_1_in.from(subhead_text.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 2)};
					...
					if(badge_text.element){frame_1_in.from(badge_text.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 3)};
					if(badge_bg_color.element){frame_1_in.from(badge_bg_color.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 3)};
					...
					if(frame_bg_color.element){frame_1_in.from(frame_bg_color.element, 1, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
