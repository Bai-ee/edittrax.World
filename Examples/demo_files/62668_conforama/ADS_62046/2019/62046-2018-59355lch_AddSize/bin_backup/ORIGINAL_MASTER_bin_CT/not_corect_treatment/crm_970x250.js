(function() {
    ...
    function Creative(dmo){
        ...
        function init(wrapperID) {
            var subdirectory = "ADS_NTB_LS_55987";            
            var creativeName = "" || subdirectory;
            var companyID = "62046";
            var isSecure = (dmo.externalURL.indexOf("https:") > -1);

            //             // var subdirectory = "ADS_NTB_LS_55987";       
            // var subdirectory = "55987_LCH_LS";             var creativeName = "" || subdirectory;
            // var companyID = "62046";
            // var isSecure = (dmo.externalURL.indexOf("https:") > -1);
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:507,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:507, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:507, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:507, pointerEvents:"none", parentNode:stage}).render()
            };
...
///////////////////////////////////////////////////
	...
	fontSize: R.create("var").set({name:"headline_text_font_size", defaultValue:"58", dataType:"Sring", required:false, exposed:true}).render().value(),
	fontFamily: R.create("var").set({name:"headline_text_font_id", defaultValue:"10747", dataType:"String", required:false, exposed:true}).render().value(),
	...
	letterSpacing: R.create("var").set({name:"headline_text_tracking", defaultValue:"1.45", dataType:"String", required:false, exposed:true}).render().value(),
	...
	fontSize: R.create("var").set({name:"cta_text_font_size", defaultValue:"22", dataType:"String", required:false, exposed:true}).render().value(),
	...
	lineHeight: R.create("var").set({name:"cta_text_line_height", defaultValue:"1", dataType:"Color", required:false, exposed:true}).render().value(),
	letterSpacing: R.create("var").set({name:"cta_text_tracking", defaultValue:"0.55", dataType:"String", required:false, exposed:true}).render().value(),
	borderRadius: R.create("var").set({name:"cta_text_border_radius", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
	border: R.create("var").set({name:"cta_text_border", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
					...
					padding: R.create("var").set({name:"cta_text_padding", defaultValue:"10px 20px 10px 20px", dataType:"String", required:false, exposed:true}).render().value(),
					left: 324,
					top: 176,
					width: 568,
					height: 52,
			...
			var gradient_horizontal_color = R.create("div").set({
				css:{
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"gradient_horizontal_color", defaultValue:"rgba(0,0,0,0.5)", dataType:"String", required:false, exposed:true}).render().value(),
					borderRadius: 0,
			...
			var group7Array = [headline_text, cta_text];
			var allElementsArr = [stageBlock,stageBlock, fg_img, style_img, replay_img, bg_img, logo_bg_color, gradient_horizontal_color, bg_color, replayContainer];
			...
			R.create("var").set({name:"gradient_vertical_color", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"gradient_vertical_border", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"gradient_square_color", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"gradient_square_border", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"duration", defaultValue:"", dataType:"Number", required:false, exposed:true});

			R.create("var").set({name:"headline_text_font_id", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"headline_text_font_size", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"headline_text_line_height", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"headline_text_padding", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"headline_text_tracking", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"headline_text_bg_color", defaultValue:"", dataType:"Color", required:false, exposed:true});

			R.create("var").set({name:"cta_text_border", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"cta_text_border_radius", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"cta_text_font_id", defaultValue:"", dataType:"Number", required:false, exposed:true});
			R.create("var").set({name:"cta_text_font_size", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"cta_text_line_height", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"cta_text_padding", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"cta_text_tracking", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"cta_text_bg_color", defaultValue:"", dataType:"Color", required:false, exposed:true});
			
			R.create("var").set({name:"gradient_horizontal_color", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"gradient_square_color", defaultValue:"", dataType:"String", required:false, exposed:true});
            ...
            function animateElements() {
				...
				function hoverExecute(isHovering){

				    var resize = isHovering ? 1.03 : 1;
					TweenMax.to(cta_text.element,.25,{scale:resize, ease: "Power4.EaseOut"});
        		...
        		replay_img.on("mouseover", function() {
				  TweenMax.to(replay_img.element,.25,{rotation:"+=360", ease: "Power4.EaseOut"});
				});

				replay_img.on("mouseout", function() {
        			TweenMax.set(replay_img.element,{rotation:0});
				});
				

                var all_frames = new TimelineMax()
                    if(stageBlock.element){all_frames.to(stageBlock.element, 1, {autoAlpha: 0, ease: 'Power1.easeInOut'}, 0)};
					if(logo_img.element){all_frames.from(logo_img.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};


					if(headline_text.element){all_frames.from(headline_text.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 2.5)};
					if(cta_text.element){all_frames.from(cta_text.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 3.5)};
                    if(lifestyle_img.element){all_frames.from(lifestyle_img.element, 2, {y:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};

                    if(lifestyle_img.element){all_frames.from(gradient_horizontal_color.element, 2, {autoAlpha: 0, ease: 'Power1.easeOut'}, 2.5)};
                    if(lifestyle_img.element){all_frames.from(replay_img.element, 1, {autoAlpha: 0}, 5)};
