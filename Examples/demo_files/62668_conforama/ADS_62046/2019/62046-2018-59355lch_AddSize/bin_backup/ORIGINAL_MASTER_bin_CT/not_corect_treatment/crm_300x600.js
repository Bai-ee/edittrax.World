(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:517,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:517, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:517, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:517, pointerEvents:"none", parentNode:stage}).render()
            };
...
///////////////////////////////////////////////////
			...
			var headline_text = R.create("div").set({
				css:{
					...
					letterSpacing: R.create("var").set({name:"headline_text_tracking", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
    ...
    fontFamily: R.create("var").set({name:"cta_text_font_id", defaultValue:10747, dataType:"Number", required:false, exposed:true}).render().value(),
			...
			var group2Array = [headline_text, cta_text];
            ...
            function animateElements() {
                ...
                var all_frames = new TimelineMax()
                    ...
                    if(cta_text.element){all_frames.from(cta_text.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut', onCOmplete:hoverOn}, 3.5)};
