(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:753,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:753, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:753, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:753, pointerEvents:"none", parentNode:stage}).render()
            };
...
///////////////////////////////////////////////////
			...
			var headline_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"headline_text_font_size", defaultValue:"15", dataType:"String", required:false, exposed:true}).render().value(),
					...
					lineHeight: R.create("var").set({name:"headline_text_line_height", defaultValue:"1.13", dataType:"String", required:false, exposed:true}).render().value(),
					letterSpacing: R.create("var").set({name:"headline_text_tracking", defaultValue:"0.375", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "center",
			...
			var cta_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"cta_text_font_size", defaultValue:"8", dataType:"String", required:false, exposed:true}).render().value(),
					...
					letterSpacing: R.create("var").set({name:"cta_text_tracking", defaultValue:"0.2", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "center",
					verticalAlign: "middle",
					marginTop: 4,
					...
					padding: R.create("var").set({name:"cta_text_padding", defaultValue:"5px 7px 5px 7px", dataType:"String", required:false, exposed:true}).render().value(),
					left: 9,
					top: 110,
					width: 162,
					height: 20,
			...
			var details_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"details_text_font_size", defaultValue:"6", dataType:"String", required:false, exposed:true}).render().value(),
					...
					fontStyle: "Light",
					lineHeight: R.create("var").set({name:"details_text_line_height", defaultValue:"1.17", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var subhead_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"subhead_text_font_size", defaultValue:"10", dataType:"String", required:false, exposed:true}).render().value(),
					...
					letterSpacing: R.create("var").set({name:"subhead_text_tracking", defaultValue:"0.25", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "center",
					verticalAlign: "middle",
					marginTop: 0,
			...
			var badge_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"badge_text_font_size", defaultValue:"9", dataType:"String", required:false, exposed:true}).render().value(),
					...
					fontStyle: "RomanFamily",
					lineHeight: R.create("var").set({name:"badge_text_line_height", defaultValue:"1.22", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var group4Array = [headline_text, cta_text, details_text];
			var allElementsArr = [subhead_text, badge_text, fg_img, style_img, replay_img, card_small_img, frame_img, promo_style_img, card_large_img, bg_img, badge_bg_color, logo_bg_color, frame_bg_color, overlay_color, bg_color, replayContainer];
			...
			///////////////////////////////////////////////////
                ...
                var frame_1_in = new TimelineMax()
					...
					if(fg_img.element){frame_1_in.from(fg_img.element, 2, {y:-5, autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(style_img.element){frame_1_in.from(style_img.element, 2, {y:-5, autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(logo_img.element){frame_1_in.from(logo_img.element, 2, {y:-5, autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(headline_text.element){frame_1_in.from(headline_text.element, 2, {y:-5, autoAlpha: 0, ease: 'Power1.easeOut'}, 1.5)};
					if(cta_text.element){frame_1_in.from(cta_text.element, 2, {y:-5, autoAlpha: 0, ease: 'Power1.easeOut'}, 2.5)};
					if(details_text.element){frame_1_in.from(details_text.element, 2, {y:-5, autoAlpha: 0, ease: 'Power1.easeOut'}, 2.5)};
					if(card_small_img.element){frame_1_in.from(card_small_img.element, 2, {y:-5, autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};
					if(frame_img.element){frame_1_in.from(frame_img.element, 2, {autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(card_large_img.element){frame_1_in.from(card_large_img.element, 2, {y:-5, autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};
					if(logo_bg_color.element){frame_1_in.from(logo_bg_color.element, 2, {y:-5, autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
                    if(logo_bg_color.element){frame_1_in.from(promo_style_img.element, 2, {x:-5,autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(frame_bg_color.element){frame_1_in.from(frame_bg_color.element, 2, {y:-5, autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
