...
///////////////////////////////////////////////////
	...
	border: R.create("var").set({name:"cta_text_border", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var gradient_vertical_color = R.create("div").set({
				css:{
					left: 13,
					top: 124,
					zIndex: 125,
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"gradient_vertical_color", defaultValue:"linear-gradient(180deg, rgba(0,0,0,0), rgba(0,0,0,0.6))", dataType:"String", required:false, exposed:true}).render().value(),
					borderRadius: 0,
					border: R.create("var").set({name:"gradient_vertical_border", defaultValue:"0px solid rgba(undefined,0)", dataType:"String", required:false, exposed:true}).render().value(),
					visibility: "hidden"
				},
				rosetta:{
					parentNode:stage
			...
			var group5Array = [headline_text, cta_text];
			var allElementsArr = [stageBlock,fg_img, style_img, bg_img, logo_bg_color, gradient_vertical_color, bg_color];
            ...
            function animateElements() {
                ...
                var all_frames = new TimelineMax()
					...
					// if(logo_bg_color.element){all_frames.from(logo_bg_color.element, 2, {y:-10, autoAlpha: 0, ease: 'Power4.easeOut'}, 0)};
                    ...
                    if(lifestyle_img.element){all_frames.from(gradient_vertical_color.element, 2, {autoAlpha: 0, ease: 'Power1.easeOut'}, 3.5)};
