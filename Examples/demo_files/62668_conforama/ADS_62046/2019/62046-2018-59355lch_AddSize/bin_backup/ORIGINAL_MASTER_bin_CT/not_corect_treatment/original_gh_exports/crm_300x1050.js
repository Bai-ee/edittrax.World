        ...
        function createElements(){
			...
			var gradient_vertical_color = R.create("div").set({
				css:{
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"gradient_vertical_color", defaultValue:"linear-gradient(180deg, rgba(0,0,0,0), rgba(0,0,0,0.6))", dataType:"Color", required:false, exposed:true}).render().value(),
					borderRadius: 0,
			...
			var allElementsArr = [fg_img, style_img, bg_img, logo_bg_color, gradient_vertical_color, bg_color];
            ...
            function animateElements() {
                var all_frames = new TimelineMax()
					...
					if(headline_text.element){all_frames.from(headline_text.element, 1, {autoAlpha: 0, ease: 'Power4.easeOut'}, 1)};
					if(cta_text.element){all_frames.from(cta_text.element, 1, {autoAlpha: 0, ease: 'Power4.easeOut'}, 1.5)};
					if(gradient_vertical_color.element){all_frames.from(gradient_vertical_color.element, 1, {autoAlpha: 0, ease: 'Power4.easeOut'}, 1)};
