(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:752,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:752, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:752, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:752, pointerEvents:"none", parentNode:stage}).render()
            };
...
///////////////////////////////////////////////////
			...
			var cta_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"cta_text_font_size", defaultValue:"11", dataType:"String", required:false, exposed:true}).render().value(),
					...
					letterSpacing: R.create("var").set({name:"cta_text_tracking", defaultValue:"0.275", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "center",
					...
					padding: R.create("var").set({name:"cta_text_padding", defaultValue:"7px 9px 7px 9px", dataType:"String", required:false, exposed:true}).render().value(),
					left: 579,
					top: 16,
					width: 128,
					height: 27,
			...
			var details_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"details_text_font_size", defaultValue:"8", dataType:"String", required:false, exposed:true}).render().value(),
					...
					fontStyle: "Light",
					lineHeight: R.create("var").set({name:"details_text_line_height", defaultValue:"1.25", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var headline_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"headline_text_font_size", defaultValue:"24", dataType:"String", required:false, exposed:true}).render().value(),
					...
					fontStyle: "RomanFamily",
					lineHeight: R.create("var").set({name:"headline_text_line_height", defaultValue:"1.08", dataType:"String", required:false, exposed:true}).render().value(),
					letterSpacing: R.create("var").set({name:"headline_text_tracking", defaultValue:"0.6", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "left",
					verticalAlign: "middle",
					marginTop: 0,
			...
			var subhead_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"subhead_text_font_size", defaultValue:"16", dataType:"String", required:false, exposed:true}).render().value(),
					...
					letterSpacing: R.create("var").set({name:"subhead_text_tracking", defaultValue:"0.4", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "left",
					verticalAlign: "middle",
					marginTop: 0,
			...
			var badge_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"badge_text_font_size", defaultValue:"12", dataType:"String", required:false, exposed:true}).render().value(),
        	...
        	if (card_large_img.backgroundImage){
         		card_small_img.display = "none";    		
        	}
        	if (card_large_img.backgroundImage && lifestyle_img.backgroundImage){
         			card_small_img.display = "block"; 
         			// TweenMax.set(cta_text.element, {top:141}); 
        	}
			
			/* [BATCH_LOADING] */
			var requiredArr = [headline_text, logo_img];
			var group5Array = [cta_text, details_text];
			var allElementsArr = [headline_text, subhead_text, badge_text, fg_img, style_img, replay_img, card_small_img, frame_img, promo_style_img, card_large_img, lifestyle_img, bg_img, line_color, badge_bg_color, logo_bg_color, frame_bg_color, overlay_color, bg_color, replayContainer];
			
			var group5 = R.create("AlignmentGroup").set({
				verticalAlign: "middle"
			}).add(group5Array).render();
          ...
          R.create("var").set({name:"headline_text_font_id", defaultValue:"", dataType:"Number", required:false, exposed:true});
          R.create("var").set({name:"headline_text_line_height", defaultValue:"", dataType:"String", required:false, exposed:true});
          R.create("var").set({name:"headline_text_tracking", defaultValue:"", dataType:"String", required:false, exposed:true});
          R.create("var").set({name:"headline_text_font_size", defaultValue:"", dataType:"Number", required:false, exposed:true});

          R.create("var").set({name:"subhead_text_font_id", defaultValue:"", dataType:"Number", required:false, exposed:true});
          R.create("var").set({name:"subhead_text_line_height", defaultValue:"", dataType:"String", required:false, exposed:true});
          R.create("var").set({name:"subhead_text_tracking", defaultValue:"", dataType:"String", required:false, exposed:true});
          R.create("var").set({name:"subhead_text_font_size", defaultValue:"", dataType:"Number", required:false, exposed:true});

          R.create("var").set({name:"cta_text_font_id", defaultValue:"", dataType:"Number", required:false, exposed:true});
          R.create("var").set({name:"cta_text_line_height", defaultValue:"", dataType:"String", required:false, exposed:true});
          R.create("var").set({name:"cta_text_tracking", defaultValue:"", dataType:"String", required:false, exposed:true});
          R.create("var").set({name:"cta_text_font_size", defaultValue:"", dataType:"Number", required:false, exposed:true});

          R.create("var").set({name:"details_text_font_id", defaultValue:"", dataType:"Number", required:false, exposed:true});
          R.create("var").set({name:"details_text_line_height", defaultValue:"", dataType:"String", required:false, exposed:true});
          R.create("var").set({name:"details_text_tracking", defaultValue:"", dataType:"String", required:false, exposed:true});
          R.create("var").set({name:"details_text_font_size", defaultValue:"", dataType:"Number", required:false, exposed:true});

          R.create("var").set({name:"badge_text_font_id", defaultValue:"", dataType:"Number", required:false, exposed:true});
          R.create("var").set({name:"badge_text_line_height", defaultValue:"", dataType:"String", required:false, exposed:true});
          R.create("var").set({name:"badge_text_tracking", defaultValue:"", dataType:"String", required:false, exposed:true});
          R.create("var").set({name:"badge_text_font_size", defaultValue:"", dataType:"Number", required:false, exposed:true});

          R.create("var").set({name:"cta_text_border", defaultValue:"", dataType:"String", required:false, exposed:true});
          R.create("var").set({name:"cta_border_corner_radius", defaultValue:"", dataType:"String", required:false, exposed:true});
          R.create("var").set({name:"cta_text_border", defaultValue:"", dataType:"String", required:false, exposed:true});
            ...
            function animateElements(){
             //MOUSE EVENTS/////////////////////////////////////
              ...
              pointers = false;
              replay_img.pointerEvents = "none";
              hit_area.pointerEvents = "none";

              var hoverTl;

              function hoverEffectHitArea(isHovering){

                var hoverOpacity = 1;
                var hoverOpacityNone = 0;

                if(isHovering){
                  hoverTl = new TimelineMax()
                  hoverTl.to(badge_text.element, .75, {autoAlpha: hoverOpacity, ease: 'Power1.easeOut'},0);
                  hoverTl.to(badge_bg_color.element, .75, {autoAlpha: hoverOpacity, ease: 'Power1.easeOut'},0);
                }
                if(!isHovering){
                  hoverTl = new TimelineMax()
                  hoverTl.to(badge_text.element, .75, {autoAlpha: hoverOpacityNone, ease: 'Power1.easeOut'},0);
                  hoverTl.to(badge_bg_color.element, .75, {autoAlpha: hoverOpacityNone, ease: 'Power1.easeOut'},0);
                }
              };

              function hoverEffectReplay(){
                  TweenMax.to(replay_img.element, .75, {rotation:"+=360"});
              };
              ...
              function hoverEvents(){
                ...
                hit_area.on("mouseover", function () {
                    hoverEffectHitArea(true)
                  });
                hit_area.on("mouseout", function () {
                    hoverEffectHitArea(false)
                  });

                 replay_img.on("mouseover", function () {
                  hoverEffectReplay(true)
                  });
              }

              setTimeout(function(){ hoverEvents() }, 2000);
            ...
            // All Animation goes here
                ...
                var frame_1_in = new TimelineMax()
					...
					if(fg_img.element){frame_1_in.from(fg_img.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(style_img.element){frame_1_in.from(style_img.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(logo_img.element){frame_1_in.from(logo_img.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(card_small_img.element){frame_1_in.from(card_small_img.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};
					if(line_color.element){frame_1_in.from(line_color.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 0.25)};
					if(cta_text.element){frame_1_in.from(cta_text.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 1)};
					if(details_text.element){frame_1_in.from(details_text.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 1.5)};
					if(headline_text.element){frame_1_in.from(headline_text.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};
					if(frame_img.element){frame_1_in.from(frame_img.element, 2, {autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(card_large_img.element){frame_1_in.from(card_large_img.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};
					if(lifestyle_img.element){frame_1_in.from(lifestyle_img.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};
                    if(lifestyle_img.element){frame_1_in.from(promo_style_img.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};
					if(logo_bg_color.element){frame_1_in.from(logo_bg_color.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(frame_bg_color.element){frame_1_in.from(frame_bg_color.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
				...
				var frame_2_in = new TimelineMax()
					if(subhead_text.textContent){
						frame_2_in.from(subhead_text.element, 2, {autoAlpha: 0, ease: 'Power1.easeOut'}, 0)
					};
				...
				var frame_3_in = new TimelineMax()
					if(replay_img.element){frame_3_in.from(replay_img.element, 1, {autoAlpha: 0, ease: 'Power1.easeOut', onComplete:hoverEvents}, 0.5)};
					if(!subhead_text.textContent){
					} else {
					if(headline_text.element){frame_3_in.fromTo(headline_text.element, 1, {top:headline_textTop, left:headline_textLeft, autoAlpha:0},{autoAlpha: 1, ease: 'Power1.easeOut', immediateRender:false}, 0)};
					}					
