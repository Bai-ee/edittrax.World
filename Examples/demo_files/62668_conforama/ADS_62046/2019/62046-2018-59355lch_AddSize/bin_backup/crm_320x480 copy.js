        ...
        function createElements(){
			...
			var cta_text = R.create("div").set({
				css:{
					...
					verticalAlign: "middle",
					marginTop: 16,
					backgroundColor: R.create("var").set({name:"cta_text_bg_color", defaultValue:"#000000", dataType:"Color", required:false, exposed:true}).render().value(),
					border: "",
					borderRadius: 0,
			...
			var badge_bg_color = R.create("div").set({
				css:{
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"badge_bg_color", defaultValue:"", dataType:"Color", required:false, exposed:true}).render().value(),
					borderRadius: R.create("var").set({name:"badge_bg_border_radius", defaultValue:"", dataType:"Number", required:false, exposed:true}).render().value(),
					border: R.create("var").set({name:"badge_bg_border", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
					visibility: "hidden"
				},
				rosetta:{
					parentNode:stage
			...
			var logo_bg_color = R.create("div").set({
				css:{
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"logo_bg_color", defaultValue:"", dataType:"Color", required:false, exposed:true}).render().value(),
					borderRadius: R.create("var").set({name:"logo_bg_border_radius", defaultValue:"", dataType:"Number", required:false, exposed:true}).render().value(),
					border: R.create("var").set({name:"logo_bg_border", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
					visibility: "hidden"
				},
				rosetta:{
					parentNode:stage
			...
			var frame_bg_color = R.create("div").set({
				css:{
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"frame_bg_color", defaultValue:"", dataType:"Color", required:false, exposed:true}).render().value(),
					borderRadius: R.create("var").set({name:"frame_bg_border_radius", defaultValue:"", dataType:"Number", required:false, exposed:true}).render().value(),
					border: R.create("var").set({name:"frame_bg_border", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
					visibility: "hidden"
				},
				rosetta:{
					parentNode:stage
			...
			var overlay_color = R.create("div").set({
				css:{
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"overlay_color", defaultValue:"", dataType:"Color", required:false, exposed:true}).render().value(),
					borderRadius: R.create("var").set({name:"overlay_border_radius", defaultValue:"", dataType:"Number", required:false, exposed:true}).render().value(),
					border: R.create("var").set({name:"overlay_border", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
					visibility: "hidden"
				},
				rosetta:{
					parentNode:stage
			...
			var bg_color = R.create("div").set({
				css:{
					...
					borderRadius: R.create("var").set({name:"bg_border_radius", defaultValue:"", dataType:"Number", required:false, exposed:true}).render().value(),
					border: R.create("var").set({name:"bg_border", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
					visibility: "hidden"
				},
				rosetta:{
					parentNode:stage
            ...
            function animateElements() {
                var frame_1_in = new TimelineMax()
					...
					if(headline_text.element){frame_1_in.from(headline_text.element, 2, {autoAlpha: 0, ease: 'Power1.easeOut'}, 1.5)};
					if(subhead_text.element){frame_1_in.from(subhead_text.element, 2, {autoAlpha: 0, ease: 'Power1.easeOut'}, 2)};
					...
					if(lifestyle_img.element){frame_1_in.from(lifestyle_img.element, 1, {autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};
