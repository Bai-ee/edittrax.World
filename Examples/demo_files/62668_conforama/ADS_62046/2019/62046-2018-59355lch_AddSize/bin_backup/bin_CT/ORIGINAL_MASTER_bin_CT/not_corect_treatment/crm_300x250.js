    ...
    function Creative(dmo){
        ...
        function init(wrapperID) {
            ...
            var config = {
                ...
                paths: {},
                bundles: {
                    "Rosetta":["core.pack","ad.pack","cnvr.advantage.pack","cnvr.usweb.pack","filters.pack","tweenmax.pack","alignmentgroup.pack"]
                }
            };
...
///////////////////////////////////////////////////
	...
	fontSize: R.create("var").set({name:"headline_text_font_size", defaultValue:"24", dataType:"Sring", required:false, exposed:true}).render().value(),
	...
	border: R.create("var").set({name:"cta_text_border", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
					...
					padding: R.create("var").set({name:"cta_text_padding", defaultValue:"5px 13px 5px 13px", dataType:"String", required:false, exposed:true}).render().value(),
					left: 27,
					top: 214,
					width: 246,
					height: 24,
			...
			var gradient_square_color = R.create("div").set({
				css:{
					left: 10,
					top: 60,
					zIndex: 119,
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"gradient_square_color", defaultValue:"linear-gradient(180deg, rgba(0,0,0,0), rgba(0,0,0,0.4))", dataType:"String", required:false, exposed:true}).render().value(),
					borderRadius: 0,
					border: R.create("var").set({name:"gradient_square_border", defaultValue:"0px solid rgba(undefined,0)", dataType:"String", required:false, exposed:true}).render().value(),
					visibility: "hidden"
				},
				rosetta:{
					parentNode:stage
			...
			var group4Array = [headline_text, cta_text];
			var allElementsArr = [stageBlock,fg_img, style_img, bg_img, logo_bg_color, gradient_square_color, bg_color];
            ...
            function animateElements() {
                ...
                var all_frames = new TimelineMax()
                    ...
                    if(lifestyle_img.element){all_frames.from(gradient_square_color.element, 2, {autoAlpha: 0, ease: 'Power1.easeOut'}, 3.5)};
