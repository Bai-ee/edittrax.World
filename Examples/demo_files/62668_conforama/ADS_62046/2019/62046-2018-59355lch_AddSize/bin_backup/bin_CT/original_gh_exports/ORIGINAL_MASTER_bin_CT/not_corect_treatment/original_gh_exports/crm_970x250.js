(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
			...
			var allElementsArr = [fg_img, style_img, replay_img, bg_img, logo_bg_color, gradient_horizontal_color, bg_color, replayContainer];
			...
			R.create("var").set({name:"gradient_vertical_color", defaultValue:"", dataType:"Color", required:false, exposed:true});
			R.create("var").set({name:"gradient_vertical_border", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"gradient_square_color", defaultValue:"", dataType:"Color", required:false, exposed:true});
            ...
            function animateElements() {
                var all_frames = new TimelineMax()
					if(replay_img.element){all_frames.from(replay_img.element, 1, {autoAlpha: 0, ease: 'Power4.easeOut'}, 2.5)};
					...
					if(cta_text.element){all_frames.from(cta_text.element, 1, {autoAlpha: 0, ease: 'Power4.easeOut'}, 2)};
