...
///////////////////////////////////////////////////
			...
			var cta_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"cta_text_font_size", defaultValue:"7", dataType:"String", required:false, exposed:true}).render().value(),
					...
					letterSpacing: R.create("var").set({name:"cta_text_tracking", defaultValue:"0.175", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "center",
			...
			var headline_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"headline_text_font_size", defaultValue:"12", dataType:"String", required:false, exposed:true}).render().value(),
					...
					letterSpacing: R.create("var").set({name:"headline_text_tracking", defaultValue:"0.3", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "left",
					verticalAlign: "middle",
					marginTop: 0,
			...
			var subhead_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"subhead_text_font_size", defaultValue:"9", dataType:"String", required:false, exposed:true}).render().value(),
					...
					letterSpacing: R.create("var").set({name:"subhead_text_tracking", defaultValue:"0.225", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "left",
					verticalAlign: "middle",
					marginTop: 0,
			...
			var badge_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"badge_text_font_size", defaultValue:"7", dataType:"String", required:false, exposed:true}).render().value(),
					...
					fontStyle: "RomanFamily",
					lineHeight: R.create("var").set({name:"badge_text_line_height", defaultValue:"1.29", dataType:"String", required:false, exposed:true}).render().value(),
