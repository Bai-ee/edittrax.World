...
/* harmony default export */ __webpack_exports__["default"] = (function(packs, renderDone) {
  ...
  const group1Array = [headline_text, subhead_text, cta_text, details_text];
  const group1 = R.create('AlignmentGroup').set({ rosetta: { verticalAlign: 'middle' } }).add(group1Array);

  const group2Array = null;
  const group2 = null;

  const group3Array = null;
  const group3 = null;

  const group4Array = null;
  const group4 = null;

  const group5Array = null;
  const group5 = null;
