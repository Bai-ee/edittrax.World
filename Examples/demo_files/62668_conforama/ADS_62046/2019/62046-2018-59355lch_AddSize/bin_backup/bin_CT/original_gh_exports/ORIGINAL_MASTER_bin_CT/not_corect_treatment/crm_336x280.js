...
///////////////////////////////////////////////////
	...
	fontSize: R.create("var").set({name:"headline_text_font_size", defaultValue:"28", dataType:"Sring", required:false, exposed:true}).render().value(),
	...
	letterSpacing: R.create("var").set({name:"headline_text_tracking", defaultValue:"0.7", dataType:"String", required:false, exposed:true}).render().value(),
	...
	border: R.create("var").set({name:"cta_text_border", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
					...
					padding: R.create("var").set({name:"cta_text_padding", defaultValue:"6px 14px 6px 14px", dataType:"String", required:false, exposed:true}).render().value(),
					left: 27,
					top: 239,
					width: 284,
					height: 26,
			...
			var group6Array = [headline_text, cta_text];
