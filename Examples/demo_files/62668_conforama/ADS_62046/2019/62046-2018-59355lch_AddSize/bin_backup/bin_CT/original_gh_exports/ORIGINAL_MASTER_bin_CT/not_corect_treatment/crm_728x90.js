...
///////////////////////////////////////////////////
	...
	fontSize: R.create("var").set({name:"headline_text_font_size", defaultValue:"32", dataType:"Sring", required:false, exposed:true}).render().value(),
	...
	border: R.create("var").set({name:"cta_text_border", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var allElementsArr = [stageBlock,headline_text, cta_text, fg_img, style_img, replay_img, bg_img, logo_bg_color, gradient_horizontal_color, bg_color, replayContainer];
            ...
            function animateElements() {
                ...
                var all_frames = new TimelineMax()
					...
					if(headline_text.element){all_frames.from(headline_text.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 3.5)};
                    ...
                    if(lifestyle_img.element){all_frames.from(gradient_horizontal_color.element, 2, {autoAlpha: 0, ease: 'Power1.easeOut'}, 3)};
