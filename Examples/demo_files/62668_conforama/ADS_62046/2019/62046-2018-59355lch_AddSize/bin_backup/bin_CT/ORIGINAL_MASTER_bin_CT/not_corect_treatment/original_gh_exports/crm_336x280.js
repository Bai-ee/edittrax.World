        ...
        function createElements(){
			...
			var gradient_square_color = R.create("div").set({
				css:{
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"gradient_square_color", defaultValue:"linear-gradient(180deg, rgba(0,0,0,0), rgba(0,0,0,0.4))", dataType:"Color", required:false, exposed:true}).render().value(),
					borderRadius: 0,
			...
			var allElementsArr = [fg_img, style_img, bg_img, logo_bg_color, gradient_square_color, bg_color];
            ...
            function animateElements() {
                var all_frames = new TimelineMax()
					...
					if(gradient_square_color.element){all_frames.from(gradient_square_color.element, 1, {autoAlpha: 0, ease: 'Power4.easeOut'}, 1)};
