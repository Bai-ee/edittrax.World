...
///////////////////////////////////////////////////
            ...
            function animateElements() {
				var frame_1_in = new TimelineMax()
					if(stageBlock.element){frame_1_in.to(stageBlock.element, 1, {autoAlpha: 0, ease: 'Power1.easeInOut'}, 0)};
					...
					if(frame_bg_color.element){frame_1_in.from(frame_bg_color.element, 1, {autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
