(function() {
    ...
    function Creative(dmo){
        ...
        function init(wrapperID) {
            ...
            req( ['require'].concat(config.bundles.Rosetta), function() {
                ...
                Platform.overwrite({
                    ...
                    placementWidth:Number(dmo.mediaWidth) || 800,
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:745,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:745, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:745, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:745, pointerEvents:"none", parentNode:stage}).render()
            };
...
///////////////////////////////////////////////////
			...
			var headline_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"headline_text_font_size", defaultValue:"35", dataType:"String", required:false, exposed:true}).render().value(),
					...
					lineHeight: R.create("var").set({name:"headline_text_line_height", defaultValue:"1.06", dataType:"String", required:false, exposed:true}).render().value(),
					letterSpacing: R.create("var").set({name:"headline_text_tracking", defaultValue:"0.875", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "left",
			...
			var subhead_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"subhead_text_font_size", defaultValue:"15", dataType:"String", required:false, exposed:true}).render().value(),
					...
					fontStyle: "Light",
					lineHeight: R.create("var").set({name:"subhead_text_line_height", defaultValue:"1.33", dataType:"String", required:false, exposed:true}).render().value(),
					letterSpacing: R.create("var").set({name:"subhead_text_tracking", defaultValue:"0.375", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "left",
					verticalAlign: "middle",
					marginTop: 6,
			...
			var cta_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"cta_text_font_size", defaultValue:"16", dataType:"String", required:false, exposed:true}).render().value(),
					...
					letterSpacing: R.create("var").set({name:"cta_text_tracking", defaultValue:"0.4", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "center",
					verticalAlign: "middle",
					marginTop: 6,
			...
			var details_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"details_text_font_size", defaultValue:"10", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var legal_closeX = R.create("div").set({
				...
				css: {
					...
					position: "absolute",
					borderRadius: "7px",
					backgroundColor: R.create("var").set({name:"legal_close_button_color", defaultValue:"#FFFFFF", dataType:"Color", required:false, exposed:true}).render().value(),
					color: "#FFFFFF",
					textAlign: "center"
                    // opacity: R.create("var").set({name:"legal_text_bg_color_opacity", defaultValue:1, dataType:"Number", required:false, exposed:true}).render().value()
				},
				rosetta: {
			...
			var legal_close = R.create("div").set({
				...
				css: {
					...
					cursor: "pointer",
					position: "absolute",
					color: R.create("var").set({name:"legal_close_text_color", defaultValue:"#000000", dataType:"Color", required:false, exposed:true}).render().value(),
					textAlign: "left"
				},
				rosetta: {
					parentNode: legalTextContainer
			...
			var legal_text = R.create("div").set({
				...
				css: {
					fontSize: R.create("var").set({name:"legal_text_font_size", defaultValue:"10", dataType:"Number", required:false, exposed:true}).render().value(),
					minFontSize: 12,
			...
			var legal_text_bg_color = R.create("div").set({
				...
				css: {
					...
					opacity: R.create("var").set({name:"legal_text_bg_color_opacity", defaultValue:0.8, dataType:"Number", required:false, exposed:true}).render().value(),
					cursor: "pointer"
				},
				rosetta:{
					parentNode: legalTextContainer,
			...
			if (card_large_img.backgroundImage){
         		...
         		cta_text.top = 84;
         		var group14Array = [cta_text, details_text]; 	
        	} 
        	if (!card_large_img.backgroundImage){
         		var group14Array = [card_small_img, cta_text, details_text];
        	} 
        	...
        	if (!card_small_img.backgroundImage){
         		card_small_img.display = "none";  
         		cta_text.top = 84;
         		var group14Array = [cta_text, details_text]; 	
        	} 
        	if (lifestyle_img.backgroundImage){
           	...
           	if (!lifestyle_img.backgroundImage && card_large_img.backgroundImage && card_small_img.backgroundImage){
         			card_small_img.display = "none"; 
         			cta_text.top = 84;
         			var group12Array = [cta_text, details_text]; 
        	}
        	else { 
         		var group14Array = [card_small_img, cta_text, details_text];
              cta_text.set({
                marginTop: parseInt(cta_text.marginTop) + 13
              })
        	}
			...
			var group13Array = [headline_text, subhead_text];
			...
			var group14 = R.create("AlignmentGroup").set({
				verticalAlign: "middle"
			}).add(group14Array).render();
				...
				.render({
					success: function(){
						displayLoaded([
							...
							R.filter.success(group13Array),R.filter.success(group14Array),
            ...
            // All Animation goes here
                var frame_1_in = new TimelineMax()
					...
					if(subhead_text.element){frame_1_in.from(subhead_text.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 1)};
					if(cta_text.element){frame_1_in.from(cta_text.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 2.5)};
					if(details_text.element){frame_1_in.from(details_text.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 2.5)};
					...
					if(card_small_img.element){frame_1_in.from(card_small_img.element, 2, {x:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 2)};
					if(frame_img.element){frame_1_in.from(frame_img.element, 1, {autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
