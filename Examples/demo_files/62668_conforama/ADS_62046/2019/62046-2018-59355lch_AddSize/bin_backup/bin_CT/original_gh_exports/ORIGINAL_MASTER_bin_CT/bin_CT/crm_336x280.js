(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:748,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:748, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:748, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:748, pointerEvents:"none", parentNode:stage}).render()
            };
...
///////////////////////////////////////////////////
			...
			var headline_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"headline_text_font_size", defaultValue:"30", dataType:"String", required:false, exposed:true}).render().value(),
					...
					letterSpacing: R.create("var").set({name:"headline_text_tracking", defaultValue:"0.75", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "center",
			...
			var cta_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"cta_text_font_size", defaultValue:"13", dataType:"String", required:false, exposed:true}).render().value(),
					...
					letterSpacing: R.create("var").set({name:"cta_text_tracking", defaultValue:"0.325", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "center",
					verticalAlign: "middle",
					marginTop: 8,
					...
					padding: R.create("var").set({name:"cta_text_padding", defaultValue:"8px 10px 8px 10px", dataType:"String", required:false, exposed:true}).render().value(),
					left: 28,
					top: 216,
					width: 280,
					height: 31,
			...
			var details_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"details_text_font_size", defaultValue:"9", dataType:"String", required:false, exposed:true}).render().value(),
					...
					fontStyle: "Light",
					lineHeight: R.create("var").set({name:"details_text_line_height", defaultValue:"1.2", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var subhead_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"subhead_text_font_size", defaultValue:"18", dataType:"String", required:false, exposed:true}).render().value(),
					...
					fontStyle: "Light",
					lineHeight: R.create("var").set({name:"subhead_text_line_height", defaultValue:"1.22", dataType:"String", required:false, exposed:true}).render().value(),
					letterSpacing: R.create("var").set({name:"subhead_text_tracking", defaultValue:"0.45", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "center",
					verticalAlign: "middle",
					marginTop: 0,
			...
			if (lifestyle_img.backgroundImage && card_large_img.backgroundImage && card_small_img.backgroundImage){
     			card_small_img.display = "block"; 
     			card_large_img.display = "none"; 
     			TweenMax.set(badge_text.element, {top:64}); 
    		} else if (lifestyle_img.backgroundImage && card_large_img.backgroundImage && !card_small_img.backgroundImage){
     			card_large_img.display = "none"; 
				TweenMax.set(badge_text.element, {top:83}); 
    		} else if (lifestyle_img.backgroundImage && !card_large_img.backgroundImage && !card_small_img.backgroundImage){
        		TweenMax.set(badge_text.element, {top:83}); 
        	} else if (lifestyle_img.backgroundImage && !card_large_img.backgroundImage && card_small_img.backgroundImage){
     			TweenMax.set(badge_text.element, {top:64}); 
			...
			var group9Array = [headline_text, cta_text, details_text];
			var allElementsArr = [subhead_text, badge_text, fg_img, style_img, replay_img, card_small_img, frame_img, promo_style_img, card_large_img, lifestyle_img, bg_img, badge_bg_color, logo_bg_color, frame_bg_color, overlay_color, bg_color, replayContainer];
			
			var group9 = R.create("AlignmentGroup").set({
				verticalAlign: "middle"
			}).add(group9Array).render();
            ...
            // All Animation goes here
                ...
                var frame_1_in = new TimelineMax()
					...
					if(fg_img.element){frame_1_in.from(fg_img.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(style_img.element){frame_1_in.from(style_img.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(logo_img.element){frame_1_in.from(logo_img.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(card_small_img.element){frame_1_in.from(card_small_img.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};
					if(headline_text.element){frame_1_in.from(headline_text.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 1.5)};
					if(cta_text.element){frame_1_in.from(cta_text.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 2.5)};
					if(details_text.element){frame_1_in.from(details_text.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 2.5)};
					if(frame_img.element){frame_1_in.from(frame_img.element, 2, {autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(card_large_img.element){frame_1_in.from(card_large_img.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};
                    if(lifestyle_img.element){frame_1_in.from(lifestyle_img.element, 2, {y:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};
                    if(lifestyle_img.element){frame_1_in.from(promo_style_img.element, 2, {y:-10,autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};
					if(logo_bg_color.element){frame_1_in.from(logo_bg_color.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(frame_bg_color.element){frame_1_in.from(frame_bg_color.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
				...
				var frame_2_in = new TimelineMax()
					if(subhead_text.textContent){
						frame_2_in.from(subhead_text.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 0)
					};
