(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:747,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:747, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:747, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:747, pointerEvents:"none", parentNode:stage}).render()
            };
...
///////////////////////////////////////////////////
			...
			var details_text = R.create("div").set({
				css:{
					...
					fontStyle: "Light",
					lineHeight: R.create("var").set({name:"details_text_line_height", defaultValue:"1.3", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var subhead_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"subhead_text_font_size", defaultValue:"11", dataType:"String", required:false, exposed:true}).render().value(),
					...
					fontStyle: "Light",
					lineHeight: R.create("var").set({name:"subhead_text_line_height", defaultValue:"1.36", dataType:"String", required:false, exposed:true}).render().value(),
					letterSpacing: R.create("var").set({name:"subhead_text_tracking", defaultValue:"0.275", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "left",
					verticalAlign: "middle",
					marginTop: 0,
			...
			var group10Array = [headline_text, details_text];
			var allElementsArr = [cta_text, subhead_text, badge_text, fg_img, style_img, replay_img, card_small_img, frame_img, promo_style_img, card_large_img, bg_img, line_color, badge_bg_color, logo_bg_color, frame_bg_color, overlay_color, bg_color, replayContainer];
			
			var group10 = R.create("AlignmentGroup").set({
				verticalAlign: "middle"
			}).add(group10Array).render();
			
			function additionalSettings() {

				if(headline_text.height < subhead_text.height){
					details_text.top = parseInt(subhead_text.top) + parseInt(subhead_text.height) + parseInt(details_text.marginTop)
				}
				creativeReady();
			};
            ...
            function hoverEffect(){
				...
				replay_img.on("mouseover", hoverEffect);
                ...
                var frame_1_in = new TimelineMax()
					...
					if(details_text.element){frame_1_in.from(details_text.element, 2, {x:-5,autoAlpha: 0, ease: 'Power1.easeOut'}, 1)};
					...
					if(frame_img.element){frame_1_in.from(frame_img.element, 2, {x:-5,autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
