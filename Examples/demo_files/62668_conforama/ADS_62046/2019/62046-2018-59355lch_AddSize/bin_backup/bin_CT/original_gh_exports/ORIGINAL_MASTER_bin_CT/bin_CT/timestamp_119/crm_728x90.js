...
///////////////////////////////////////////////////
			...
			R.create("var").set({name:"headline_font_id", defaultValue:"", dataType:"Number", required:false, exposed:true});
			R.create("var").set({name:"subhead_font_id", defaultValue:"", dataType:"Number", required:false, exposed:true});
			R.create("var").set({name:"cta_font_id", defaultValue:"", dataType:"Number", required:false, exposed:true});
			R.create("var").set({name:"details_font_id", defaultValue:"", dataType:"Number", required:false, exposed:true});
			R.create("var").set({name:"badge_font_id", defaultValue:"", dataType:"Number", required:false, exposed:true});
			...
			R.create("var").set({name:"cta_text_border", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"cta_text_border", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"second_offer_text", defaultValue:"", dataType:"String", required:false, exposed:true});
			...
			function hoverEffect(){
			  if(!hover){
			    ...
			    hoverTl.to(badge_text.element, .75, {autoAlpha: 1, ease: 'Power1.easeOut'},0);
			    hoverTl.to(badge_bg_color.element, .75, {autoAlpha: 1, ease: 'Power1.easeOut'},0);
			    hoverTl.to(logo_img.element, .75, {y:-5, ease: 'Power1.easeOut'},0);
			    hoverTl.to(replay_img.element, .75, {rotation:360},0);
			    hover = true;
			  } else {
			    hoverTl.reverse();
			    hover = false;
