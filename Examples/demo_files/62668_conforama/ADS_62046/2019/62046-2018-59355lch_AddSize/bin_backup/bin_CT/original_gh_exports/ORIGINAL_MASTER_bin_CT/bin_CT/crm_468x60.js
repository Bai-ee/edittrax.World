(function() {
    ...
    function Creative(dmo){
        ...
        function init(wrapperID) {
            ...
            req( ['require'].concat(config.bundles.Rosetta), function() {
                ...
                Platform.overwrite({
                    ...
                    placementWidth:Number(dmo.mediaWidth) || 468,
                    placementHeight:Number(dmo.mediaHeight) || 60,
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:751,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:751, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:751, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:751, pointerEvents:"none", parentNode:stage}).render()
            };
...
///////////////////////////////////////////////////
			...
			var cta_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"cta_text_font_size", defaultValue:"9", dataType:"String", required:false, exposed:true}).render().value(),
					...
					letterSpacing: R.create("var").set({name:"cta_text_tracking", defaultValue:"0.225", dataType:"String", required:false, exposed:true}).render().value(),					
					textAlign: "center",
			...
			var details_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"details_text_font_size", defaultValue:"7", dataType:"String", required:false, exposed:true}).render().value(),
					...
					fontStyle: "Light",
					lineHeight: R.create("var").set({name:"details_text_line_height", defaultValue:"1.29", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var headline_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"headline_text_font_size", defaultValue:"17", dataType:"String", required:false, exposed:true}).render().value(),
					...
					fontStyle: "RomanFamily",
					lineHeight: R.create("var").set({name:"headline_text_line_height", defaultValue:"1.12", dataType:"String", required:false, exposed:true}).render().value(),
					letterSpacing: R.create("var").set({name:"headline_text_tracking", defaultValue:"0.425", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "left",
					verticalAlign: "middle",
					marginTop: 0,
			...
			var subhead_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"subhead_text_font_size", defaultValue:"12", dataType:"String", required:false, exposed:true}).render().value(),
					...
					letterSpacing: R.create("var").set({name:"subhead_text_tracking", defaultValue:"0.3", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "left",
					verticalAlign: "middle",
					marginTop: 0,
			...
			var badge_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"badge_text_font_size", defaultValue:"8", dataType:"String", required:false, exposed:true}).render().value(),
					...
					fontStyle: "RomanFamily",
					lineHeight: R.create("var").set({name:"badge_text_line_height", defaultValue:"1.25", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var group6Array = [cta_text, details_text];
			...
			var group6 = R.create("AlignmentGroup").set({
				verticalAlign: "middle"
			}).add(group6Array).render();
			...
			///////////////////////////////////////////////////
                ...
                var frame_1_in = new TimelineMax()
					...
					if(fg_img.element){frame_1_in.from(fg_img.element, 2, {x:-5,autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(style_img.element){frame_1_in.from(style_img.element, 2, {x:-5,autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(logo_img.element){frame_1_in.from(logo_img.element, 2, {x:-5,autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(line_color.element){frame_1_in.from(line_color.element, 2, {x:-5,autoAlpha: 0, ease: 'Power1.easeOut'}, 0.25)};
					if(cta_text.element){frame_1_in.from(cta_text.element, 2, {x:-5,autoAlpha: 0, ease: 'Power1.easeOut'}, 1)};
					if(details_text.element){frame_1_in.from(details_text.element, 2, {x:-5,autoAlpha: 0, ease: 'Power1.easeOut'}, 1.5)};
					if(headline_text.element){frame_1_in.from(headline_text.element, 2, {x:-5,autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};
					if(card_small_img.element){frame_1_in.from(card_small_img.element, 2, {x:-5,autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};
					if(frame_img.element){frame_1_in.from(frame_img.element, 2, {autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(card_large_img.element){frame_1_in.from(card_large_img.element, 2, {x:-5,autoAlpha: 0, ease: 'Power1.easeOut'}, 0.5)};
					if(logo_bg_color.element){frame_1_in.from(logo_bg_color.element, 2, {x:-5,autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
					if(frame_bg_color.element){frame_1_in.from(frame_bg_color.element, 2, {x:-5,autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
