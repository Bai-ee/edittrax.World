(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:506,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:506, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:506, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:506, pointerEvents:"none", parentNode:stage}).render()
            };
...
///////////////////////////////////////////////////
	...
	fontSize: R.create("var").set({name:"headline_text_font_size", defaultValue:"50", dataType:"Sring", required:false, exposed:true}).render().value(),
	...
	letterSpacing: R.create("var").set({name:"headline_text_tracking", defaultValue:"1.25", dataType:"String", required:false, exposed:true}).render().value(),
	...
	border: R.create("var").set({name:"cta_text_border", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
					...
					padding: R.create("var").set({name:"cta_text_padding", defaultValue:"9px 18px 9px 18px", dataType:"String", required:false, exposed:true}).render().value(),
					left: 255,
					top: 167,
					width: 494,
					height: 47,
			...
			var group8Array = [headline_text, cta_text];
			var allElementsArr = [stageBlock,fg_img, style_img, replay_img, bg_img, logo_bg_color, gradient_horizontal_color, bg_color, replayContainer];
