(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:754,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:754, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:754, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:754, pointerEvents:"none", parentNode:stage}).render()
            };
...
///////////////////////////////////////////////////
			...
			var cta_text = R.create("div").set({
				css:{
					...
					letterSpacing: R.create("var").set({name:"cta_text_tracking", defaultValue:"0.3", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "center",
					verticalAlign: "middle",
					marginTop: 7,
			...
			var badge_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"badge_text_font_size", defaultValue:"11", dataType:"String", required:false, exposed:true}).render().value(),
					...
					fontStyle: "RomanFamily",
					lineHeight: R.create("var").set({name:"badge_text_line_height", defaultValue:"1.18", dataType:"String", required:false, exposed:true}).render().value(),
    		...
    		if (lifestyle_img.backgroundImage && card_large_img.backgroundImage && card_small_img.backgroundImage){
     			...
     			card_large_img.display = "none"; 
				TweenMax.set(badge_text.element, {top:78}); 
    		} else if (lifestyle_img.backgroundImage && !card_large_img.backgroundImage && !card_small_img.backgroundImage){
        		TweenMax.set(badge_text.element, {top:78}); 
        	} else if (lifestyle_img.backgroundImage && !card_large_img.backgroundImage && card_small_img.backgroundImage){
     			TweenMax.set(badge_text.element, {top:64}); 
			...
			var group3Array = [headline_text, cta_text, details_text];
            ...
            function animateElements(){
             //MOUSE EVENTS/////////////////////////////////////
              ...
              function hoverEffectHitArea(isHovering){
                ...
                var hoverOpacity = isHovering ? 1 : 0;
              ...
              function hoverEffectReplay(){
                  TweenMax.to(replay_img.element, .75, {rotation:"+=360",ease:'Circ.easeInOut'});
              };
