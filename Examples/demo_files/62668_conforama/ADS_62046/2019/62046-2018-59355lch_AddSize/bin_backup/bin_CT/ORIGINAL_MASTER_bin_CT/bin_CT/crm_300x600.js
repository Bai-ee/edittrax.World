(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:756,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:756, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:756, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:756, pointerEvents:"none", parentNode:stage}).render()
            };
...
///////////////////////////////////////////////////
			...
			var headline_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"headline_text_font_size", defaultValue:"33", dataType:"String", required:false, exposed:true}).render().value(),
					...
					letterSpacing: R.create("var").set({name:"headline_text_tracking", defaultValue:"0.825", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "center",
			...
			var subhead_text = R.create("div").set({
				css:{
					...
					fontSize: R.create("var").set({name:"subhead_text_font_size", defaultValue:"14", dataType:"String", required:false, exposed:true}).render().value(),
					...
					fontStyle: "Light",
					lineHeight: R.create("var").set({name:"subhead_text_line_height", defaultValue:"1.29", dataType:"String", required:false, exposed:true}).render().value(),
					letterSpacing: R.create("var").set({name:"subhead_text_tracking", defaultValue:"0.35", dataType:"String", required:false, exposed:true}).render().value(),
					textAlign: "center",
					verticalAlign: "middle",
					marginTop: 3,
			...
			var group1Array = [headline_text, subhead_text, cta_text, details_text];
            ...
            function hoverEffect(){
			  if(!hover){
                ...
                var frame_1_in = new TimelineMax()
					...
					if(frame_img.element){frame_1_in.from(frame_img.element, 2, {y:-10, autoAlpha: 0, ease: 'Power1.easeOut'}, 0)};
