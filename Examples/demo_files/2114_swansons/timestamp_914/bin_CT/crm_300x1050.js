    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var cta_text_hover = R.create("div").set({
                css:{
                    color: R.create("var").set({name:"cta_text_hover_color", defaultValue:"#000000", dataType:"Color", required:false, exposed:true}).render().value(),
                    fontSize: 13,
                    fontFamily: 10488,
                    fontStyle: "RegularFamily",
                    lineHeight: 1.2,
            ...
            var lifestyle_img_mask = R.create("div").set({
                css:{
                    left: 0,
                    top: 157,
                    width: 310,
			...
			var allElementsArr = [stageBlock, details_text, fg_img, style_img, product_overlay_img, lifestyle_img,
                cropped_bg_img, bg_img, shape_overlay1_color, shape_overlay2_color, shape_overlay3_color,
                extended_shape_overlay1_color, extended_shape_overlay2_color, extended_shape_overlay3_color, style_bar_color,
                cta_text_hover, cta_text, bg_color, lifestyle_img_mask];
