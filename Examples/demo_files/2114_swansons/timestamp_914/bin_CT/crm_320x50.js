    ...
    function Creative(dmo){
        ...
        function init(wrapperID) {
            ...
            var config = {
                ...
                paths: {},
                bundles: {
                    "Rosetta":["core.pack","ad.pack","cnvr.advantage.pack","cnvr.usweb.pack","filters.pack","tweenmax.pack","xmlpush.pack","fontface.pack"]
                }
            };
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:770,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:770, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:770, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:770, pointerEvents:"none", parentNode:stage}).render()
            };
        ...
        attr:{
          id: "stageBlock"
			...
			//CONTAINER NEEDS SIZE ADJUSTMENT
          ...
          if(!legal_text.element.textContent){
            ...
            TweenMax.set(headline_text.element,{top:"-=5px"})
          };
			...
			var allElementsArr = [lifestyle_img_cont, details_text,stageBlock,headline_text, fg_img, style_img, product_overlay_img, lifestyle_img, cropped_bg_img, bg_img, shape_overlay1_color, shape_overlay2_color, extended_shape_overlay1_color, extended_shape_overlay2_color, style_bar_color, bg_color];
            ...
            function animateElements() {
            	...
            	TweenMax.set(product_overlay_img.element,{scale:1, y:0, x:2});
            	TweenMax.set(headline_text.element, {autoAlpha:0,/* y:-10*/});
            	...
            	tl.to(product_overlay_img.element, 1, {scale:1, x:-1, ease:"power4.easeInOut",force3D:true},0);

            	TweenMax.to(headline_text.element, 1, {autoAlpha:1, x:2, delay:.2});
             	...
             	stage.element.addEventListener("mouseover",function(){
            		...
            		TweenMax.to(product_overlay_img.element, .75, {scale:1, x:2, ease:"power4.easeInOut",force3D:true});
            	    TweenMax.to(headline_text.element, .75, {autoAlpha:.75, x:-1, ease:"power4.easeInOut",});
            	})
            	...
            	stage.element.addEventListener("mouseout",function(){
            		TweenMax.to(lifestyle_img.element,.5,{scale:1,  ease:"power4.easeInOut",force3D:true, backfaceVisibility:"hidden" })
             		TweenMax.to(product_overlay_img.element, .75, {scale:1, x:0, ease:"power4.easeInOut",force3D:true});
            	    TweenMax.to(headline_text.element, .75, {autoAlpha:1, x:2, ease:"power4.easeInOut",});
            	})
