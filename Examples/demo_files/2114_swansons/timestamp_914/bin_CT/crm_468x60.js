(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:769,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:769, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:769, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:769, pointerEvents:"none", parentNode:stage}).render()
            };
        ...
        attr:{
          ...
          if(!legal_text.element.textContent){
            ...
            TweenMax.set(headline_text.element,{top:"-=2px"})
          };

			/* [BATCH_LOADING] */
			var requiredArr = [logo_img];
			var group5Array = [headline_text, subhead_text];
			var allElementsArr = [lifestyle_img_cont, details_text, stageBlock, fg_img, style_img, product_overlay_img, lifestyle_img, cropped_bg_img, bg_img, shape_overlay1_color, shape_overlay2_color, extended_shape_overlay1_color, extended_shape_overlay2_color, style_bar_color, bg_color];
          ...
          function displayLegal(){
            ...
            function animateElements() {
            	...
            	TweenMax.set(lifestyle_img.element,{scale:1.1});
            	TweenMax.set(product_overlay_img.element,{scale:1, y:0, x:3});
            	TweenMax.set([headline_text.element, subhead_text.element], {autoAlpha:0,/* y:-10*/});
            	...
            	tl.to(product_overlay_img.element, 1, {scale:1, x:0, ease:"power4.easeInOut",force3D:true},0);

            	TweenMax.staggerTo([headline_text.element, subhead_text.element], 1, {autoAlpha:1, x:7, delay:.2},.2);
             	...
             	stage.element.addEventListener("mouseover",function(){
            		...
            		TweenMax.to(product_overlay_img.element, .75, {scale:1, x:3, ease:"power4.easeInOut",force3D:true},0);
            	    TweenMax.to([headline_text.element, subhead_text.element], .75, {autoAlpha:1, x:1},.2);
            	})
            	...
            	stage.element.addEventListener("mouseout",function(){
            		TweenMax.to(lifestyle_img.element,.5,{scale:1,  ease:"power4.easeInOut",force3D:true, backfaceVisibility:"hidden" })
             		TweenMax.to(product_overlay_img.element, .75, {scale:1, x:0, ease:"power4.easeInOut",force3D:true},0);
            	    TweenMax.to([headline_text.element, subhead_text.element], .75, {autoAlpha:1, x:5},.2);
            	})
