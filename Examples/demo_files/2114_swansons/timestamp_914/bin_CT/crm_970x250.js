...
//
          ...
          var lifestyle_img = R.create("div").set({
			...
			var allElementsArr = [lifestyle_img_cont,cta_text, cta_text_hover, stageBlock, details_text, fg_img, style_img, product_overlay_img, lifestyle_img, cropped_bg_img, bg_img, shape_overlay1_color, shape_overlay2_color, extended_shape_overlay1_color, extended_shape_overlay2_color, style_bar_color, bg_color];
