(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:768,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:768, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:768, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:768, pointerEvents:"none", parentNode:stage}).render()
            };
        ...
        attr:{
          ...
          var lifestyle_img_cont = R.create("div").set({
			...
			var allElementsArr = [lifestyle_img_cont, stageBlock,details_text, fg_img, style_img, product_overlay_img, lifestyle_img, cropped_bg_img, bg_img, shape_overlay1_color, shape_overlay2_color, extended_shape_overlay1_color, extended_shape_overlay2_color, style_bar_color, bg_color];
            ...
            function animateElements() {
            	...
            	TweenMax.set(product_overlay_img.element,{scale:.95, y:0, x:3});
            	TweenMax.set([headline_text.element, subhead_text.element], {autoAlpha:0,/* y:-10*/});
            	// TweenMax.set(cta_text_overlay.element,{opacity:0})
            	...
            	tl.to(product_overlay_img.element, 1, {scale:1, x:-3, ease:"power4.easeInOut",force3D:true},0);

            	TweenMax.staggerTo([headline_text.element, subhead_text.element], 1, {autoAlpha:1, x:6, delay:.2},.2);
             	...
             	stage.element.addEventListener("mouseover",function(){
            		...
            		TweenMax.to(product_overlay_img.element, .75, {scale:1, x:5, ease:"power4.easeInOut",force3D:true},0);
            	    TweenMax.to([headline_text.element, subhead_text.element], 1, {autoAlpha:1, x:0},.2);
            	})
            	...
            	stage.element.addEventListener("mouseout",function(){
            	    ...
            	    TweenMax.to([headline_text.element, subhead_text.element], 1, {autoAlpha:1, x:5},.2);
            	})
