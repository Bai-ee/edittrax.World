(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:767,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:767, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:767, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:767, pointerEvents:"none", parentNode:stage}).render()
            };
          ...
          var lifestyle_img_cont = R.create("div").set({
			...
			var allElementsArr = [lifestyle_img_cont, details_text,stageBlock,headline_text, fg_img, style_img, product_overlay_img, lifestyle_img, cropped_bg_img, bg_img, shape_overlay2_color, extended_shape_overlay2_color, style_bar_color, bg_color];
            ...
            function animateElements() {
            	...
            	TweenMax.set(headline_text.element,{autoAlpha:0});
            	...
            	TweenMax.to(headline_text.element, 1, {autoAlpha:1, y:3, delay:.2},.2);
              	...
              	stage.element.addEventListener("mouseover",function(){
            		...
            		TweenMax.to(product_overlay_img.element, .5, {scale:1, y:-2, ease:"power4.easeInOut",force3D:true},0);
            		// TweenMax.to(cta_text_cont.element,.5,{opacity:1})
            		// TweenMax.to(cta_text_hover.element,.2,{autoAlpha:1})
            		TweenMax.to(headline_text.element,.5,{y:-1});
            	...
            	stage.element.addEventListener("mouseout",function(){
            		TweenMax.to(lifestyle_img.element,.5,{scale:1,  ease:"power4.easeInOut",force3D:true, backfaceVisibility:"hidden" })
             		TweenMax.to(product_overlay_img.element, .5, {scale:1, y:0, ease:"power4.easeInOut",force3D:true},0);
             		// TweenMax.to(cta_text_hover.element,.5,{opacity:0})
             		// TweenMax.to(cta_text_hover.element,.2,{autoAlpha:0});
             		TweenMax.to(headline_text.element,.5,{y:0});
            	})
