(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:766,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:766, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:766, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:766, pointerEvents:"none", parentNode:stage}).render()
            };
...
//////////////////////////////////////////////////
			...
			var shape_color1 = R.create("div").set({
				css:{
					backgroundImage: R.create("var").set({name:"shape_color1", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
					backgroundSize: "contain",
					backgroundPosition: "center center",
					left: 0,
					top: 0,
				...
				rosetta:{
					parentNode:stage,
					tint: R.create("var").set({name:"shape_color1_tint", defaultValue:"", dataType:"Color", required:false, exposed:true}).render().value()
				},
				attr:{
					id: "shape_color1"
				}
      ...
      //IF THERE IS NO LEGAL TEXT DISABLE TRIGGER
			...
			var group3Array = [headline_text, subhead_text, cta_text_cont];
			var allElementsArr = [lifestyle_img_cont,details_text, cta_text_hover, cta_text,stageBlock,fg_img, shape_color1, style_img, product_overlay_img, lifestyle_img, cropped_bg_img, bg_img, shape_overlay2_color, extended_shape_overlay2_color, style_bar_color, bg_color];
            ...
            function animateElements() {
            	...
            	TweenMax.set(lifestyle_img.element,{scale:1.1});
             	cta_text_cont.element.addEventListener("click", adHit);
            	TweenMax.set(product_overlay_img.element,{/*scale:.95,*/ y:-10});
            	TweenMax.set([headline_text.element,cta_text_cont.element,subhead_text.element],{autoAlpha:0, y:-10});
            	...
            	TweenMax.staggerTo([headline_text.element,subhead_text.element,cta_text_cont.element,], 1, {autoAlpha:1, y:3, delay:.2},.1);
