    ...
    function Creative(dmo){
        ...
        function init(wrapperID) {
            ...
            var config = {
                ...
                paths: {},
                bundles: {
                    "Rosetta":[ "fontface.pack", "tweenmax.pack","core.pack","ad.pack","cnvr.advantage.pack","cnvr.usweb.pack","filters.pack","xmlpush.pack","alignmentgroup.pack"]
                }
            };
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:696,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:696, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:696, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:696, pointerEvents:"none", parentNode:stage}).render()
            };
	...
	attr:{
		id: "cta_text_cont",
	            ...
	            var cta_text_hover = R.create("div").set({
	                css:{
	                    color: R.create("var").set({name:"cta_text_hover_color", defaultValue:"", dataType:"Color", required:false, exposed:true}).render().value(),
                    fontSize: 10,
                    fontFamily: 10488,
                    fontStyle: "RegularFamily",
                    lineHeight: 1.3,
      ...
      function displayLegal(){
        ...
        if(legalTextContainer.element.style.visibility == "hidden"){
          ...
          TweenMax.to(legalTextContainer.element, .25, {autoAlpha: 0});
            ...
            // details_text.element.addEventListener("click", function(){
            //    console.log("success");
            // })

			/* [BATCH_LOADING] */
			var requiredArr = [logo_img];
			var group2Array = [headline_text, subhead_text, cta_text_cont];
			var allElementsArr = [details_text, cta_text_hover, cta_text, lifestyle_img_mask,stageBlock,fg_img, style_img, product_overlay_img, lifestyle_img, cropped_bg_img, bg_img, shape_overlay1_color, shape_overlay2_color, shape_overlay3_color, extended_shape_overlay1_color, extended_shape_overlay2_color, extended_shape_overlay3_color, style_bar_color, bg_color];
			...
			function additionalSettings() {
                ...
                // TweenMax.set(headline_text.element,{top:"+=20"});
			...
			R.create("var").set({name:"shape_color9", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"shape_color9_tint", defaultValue:"", dataType:"Color", required:false, exposed:true});

            var hit_area = R.create("div").set({id:"ad_hit", width: width, height: height, pointerEvents: "auto", cursor: "pointer", zIndex:10, parentNode:stage});
