(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:684,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:684, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:684, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:684, pointerEvents:"none", parentNode:stage}).render()
            };
			...
			var cta_text = R.create("div").set({
				css:{
					...
					padding: R.create("var").set({name:"cta_text_padding", defaultValue:"9px 18px 6px 18px", dataType:"String", required:false, exposed:true}).render().value(),
					left: 23,
					top: 194,
					width: 153,
					height: 35,
			...
			var group4Array = [headline_text, subhead_text, cta_text];
			var allElementsArr = [details_text, fg_img, style_img, product_overlay_img, lifestyle_img, cropped_bg_img, bg_img, shape_overlay1_color, shape_overlay2_color, extended_shape_overlay1_color, extended_shape_overlay2_color, style_bar_color, bg_color];
