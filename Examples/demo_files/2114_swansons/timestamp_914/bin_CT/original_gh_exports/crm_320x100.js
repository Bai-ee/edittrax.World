(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
			...
			var allElementsArr = [headline_text, details_text, fg_img, style_img, product_overlay_img, lifestyle_img, cropped_bg_img, bg_img, shape_overlay2_color, extended_shape_overlay1_color, extended_shape_overlay2_color, style_bar_color, bg_color];
