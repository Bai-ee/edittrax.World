(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:680,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:680, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:680, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:680, pointerEvents:"none", parentNode:stage}).render()
            };
			...
			var cta_text = R.create("div").set({
				css:{
					...
					padding: R.create("var").set({name:"cta_text_padding", defaultValue:"11px 20px 8px 20px", dataType:"String", required:false, exposed:true}).render().value(),
					left: 28,
					top: 873,
					width: 204,
					height: 41,
			...
			var shape_overlay1_color = R.create("div").set({
				css:{
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"shape_overlay1_color", defaultValue:"#82bc00", dataType:"Color", required:false, exposed:true}).render().value(),
					borderRadius: 0,
					visibility: "hidden"
				},
				rosetta:{
			...
			var shape_overlay2_color = R.create("div").set({
				css:{
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"shape_overlay2_color", defaultValue:"#00803d", dataType:"Color", required:false, exposed:true}).render().value(),
					borderRadius: 0,
					visibility: "hidden"
				},
				rosetta:{
			...
			var shape_overlay3_color = R.create("div").set({
				css:{
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"shape_overlay3_color", defaultValue:"#82bc00", dataType:"Color", required:false, exposed:true}).render().value(),
					borderRadius: 0,
					visibility: "hidden"
				},
				rosetta:{
			...
			var extended_shape_overlay1_color = R.create("div").set({
				css:{
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"extended_shape_overlay1_color", defaultValue:"#82bc00", dataType:"Color", required:false, exposed:true}).render().value(),
					borderRadius: 0,
					visibility: "hidden"
				},
				rosetta:{
			...
			var extended_shape_overlay2_color = R.create("div").set({
				css:{
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"extended_shape_overlay2_color", defaultValue:"#00803d", dataType:"Color", required:false, exposed:true}).render().value(),
					borderRadius: 0,
					visibility: "hidden"
				},
				rosetta:{
			...
			var extended_shape_overlay3_color = R.create("div").set({
				css:{
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"extended_shape_overlay3_color", defaultValue:"#82bc00", dataType:"Color", required:false, exposed:true}).render().value(),
					borderRadius: 0,
					visibility: "hidden"
				},
				rosetta:{
			...
			var allElementsArr = [details_text, fg_img, style_img, product_overlay_img, lifestyle_img, cropped_bg_img, bg_img, shape_overlay1_color, shape_overlay2_color, shape_overlay3_color, extended_shape_overlay1_color, extended_shape_overlay2_color, extended_shape_overlay3_color, style_bar_color, bg_color];
			...
			R.create("var").set({name:"shape_color1", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"shape_color1_tint", defaultValue:"", dataType:"Color", required:false, exposed:true});
			R.create("var").set({name:"shape_color2", defaultValue:"", dataType:"String", required:false, exposed:true});
			R.create("var").set({name:"shape_color2_tint", defaultValue:"", dataType:"Color", required:false, exposed:true});
