    ...
    function Creative(dmo){
        ...
        function init(wrapperID) {
            ...
            var config = {
                ...
                paths: {},
                bundles: {
                    "Rosetta":["core.pack","ad.pack","cnvr.advantage.pack","cnvr.usweb.pack","filters.pack","tweenmax.pack","fontface.pack"]
                }
            };
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:682,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:682, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:682, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:682, pointerEvents:"none", parentNode:stage}).render()
            };
			...
			var allElementsArr = [lifestyle_img_cont, stageBlock, headline_text, details_text, fg_img, style_img, product_overlay_img,
				lifestyle_img, cropped_bg_img, bg_img, shape_overlay2_color, shape_overlay1_color, extended_shape_overlay1_color, extended_shape_overlay2_color, style_bar_color, bg_color];
            ...
            function animateElements() {
                ...
                TweenMax.staggerTo([headline_text.element], 1, {autoAlpha:1, x:7, delay:.2},.2);
                ...
                stage.element.addEventListener("mouseover",function(){
                    ...
                    TweenMax.to([headline_text.element], .75, {autoAlpha:1, x:1},.2);
                })
                ...
                stage.element.addEventListener("mouseout",function(){
                    ...
                    TweenMax.to([headline_text.element], .75, {autoAlpha:1, x:5},.2);
                })
