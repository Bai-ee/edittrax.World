    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var shape_overlay2_color = R.create("div").set({
                css:{
                    backgroundColor: R.create("var").set({name:"shape_overlay2_color", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
            ...
            var extended_shape_overlay2_color = R.create("div").set({
                css:{
                    backgroundColor: R.create("var").set({name:"extended_shape_overlay2_color", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),
                ...
                rosetta:{
                    parentNode:stage,
                    tint: R.create("var").set({name:"extended_shape_overlay2_color_tint", defaultValue:"", dataType:"Color", required:false, exposed:true}).render().value()
                },
                attr:{
...
//////////////////////////////////////////////////
            ...
            var cta_text = R.create("div").set({
                css:{
                    color: R.create("var").set({name:"cta_text", defaultValue:"#FFFFFF", dataType:"Color", required:false, exposed:true}).render().value(),
                    fontSize: 10,
                    fontFamily: 10488,
                    fontStyle: "RegularFamily",
                    lineHeight: 1.2,
...
//////////////////////////////////////////////////
			...
			var allElementsArr = [stageBlock, lifestyle_img_cont, details_text, fg_img, style_img, product_overlay_img,
				shape_overlay2_color, lifestyle_img, cropped_bg_img, bg_img, style_bar_color,
				bg_color, cta_text, cta_text_hover, extended_shape_overlay2_color];
