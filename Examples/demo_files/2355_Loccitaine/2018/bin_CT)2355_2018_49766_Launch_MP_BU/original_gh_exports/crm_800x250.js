(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:1401,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:1401, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:1401, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:1401, pointerEvents:"none", parentNode:stage}).render()
            };
			...
			var group17Array = [headline_text, subhead_text, cta_text];
			var allElementsArr = [fg_img, style_img, nav_prev_img, nav_next_img, lifestyle_img, bg_img, style_bar_color, text_frame_color, cat_text_line1_color, cat_text_line2_color, cat_overlay_color, bg_color, rotatorFadeContainer];
			
			var group17 = R.create("AlignmentGroup").set({
				verticalAlign: "middle"
			}).add(group17Array).render();
