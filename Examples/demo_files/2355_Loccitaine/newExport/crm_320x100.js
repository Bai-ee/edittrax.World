(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
			...
			var allElementsArr = [subhead_text, fg_img, style_img, nav_prev_img, nav_next_img, lifestyle_img, bg_img, style_bar_color, text_frame_color, bg_color, rotatorFadeContainer];
