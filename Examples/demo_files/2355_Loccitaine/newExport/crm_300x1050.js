(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
			...
			var allElementsArr = [fg_img, style_img, nav_prev_img, nav_next_img, lifestyle_img, bg_img, style_bar_color, logo_bg_color, text_frame_color, cat_text_line1_color, bg_color, rotatorFadeContainer];
