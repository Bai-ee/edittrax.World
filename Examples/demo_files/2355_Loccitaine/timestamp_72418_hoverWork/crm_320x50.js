...
//
			...
			var allElementsArr = [lifestyle_img_cont,subhead_text, fg_img, style_img, nav_prev_img, nav_next_img, lifestyle_img, bg_img, style_bar_color, logo_bg_color, text_frame_color, bg_color, rotatorFadeContainer];
            ...
            function animateElements() {
              ...
              tl.from(nav_next_img.element, 2, {autoAlpha:0,x:5, onComplete:animateSecondFrame },1.4)
              tl.from(nav_prev_img.element, 2, {autoAlpha:0,x:-5, onComplete:pointerEventsOn},1.4)
