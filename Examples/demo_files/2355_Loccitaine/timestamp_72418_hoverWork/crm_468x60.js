(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:1407,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:1407, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:1407, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:1407, pointerEvents:"none", parentNode:stage}).render()
            };
...
//
			...
			var group10Array = [headline_text, subhead_text];
			var allElementsArr = [lifestyle_img_cont, fg_img, style_img, nav_prev_img, nav_next_img, lifestyle_img, bg_img, style_bar_color, logo_bg_color, text_frame_color, bg_color, rotatorFadeContainer];
