(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:1402,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:1402, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:1402, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:1402, pointerEvents:"none", parentNode:stage}).render()
            };
...
//
          ...
          padding: R.create("var").set({name:"cta_text_padding", defaultValue:"8px 12px 8px 12px", dataType:"String", required:false, exposed:true}).render().value(),
					left: 252,
					top: 214,
					width: 375,
					height: 29,
...
//CUSTOM
        ...
        catCont,
//
        cat_text_line1_color, cat_text_line2_color, fg_img, style_img, nav_prev_img, nav_next_img, lifestyle_img, bg_img, style_bar_color, text_frame_color, cat_overlay_color, bg_color, rotatorFadeContainer];
            ...
            function animateElements() {
              ...
              TweenMax.fromTo(lifestyle_img.element,3.5,{force3D:true, preserve3D:true, autoAlpha:0, scale:1},{force3D:true, preserve3D:true, scale:.96,  x:0, delay:0, autoAlpha:1,ease:easeType,});
