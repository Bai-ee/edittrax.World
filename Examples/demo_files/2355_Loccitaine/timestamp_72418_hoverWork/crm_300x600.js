...
//
        fg_img, style_img, nav_prev_img, nav_next_img, lifestyle_img, bg_img, style_bar_color, logo_bg_color, text_frame_color, /*cat_text_line1_color, cat_text_line2_color,*/ cat_overlay_color, bg_color, rotatorFadeContainer];
            ...
            function animateElements() {
              ...
              var hoverOn = 0;
              var hoverWidth = width;
              var hoverHeight = parseInt(lifestyle_img_cont.height);
              ...
              // TweenMax.fromTo(lifestyle_img.element,3.5,{force3D:true, preserve3D:true, autoAlpha:0, scale:1},{force3D:true, preserve3D:true, scale:.98,  x:0, delay:0, autoAlpha:1,ease:easeType,});
              ...
              function hover(){
                if (hoverOn === 0){
                  TweenMax.to([catCont.element, cat_overlay_color.element],.5, {autoAlpha:1, ease:"Power2.easeOut"});
                  // TweenMax.to(lifestyle_img.element, .5, {force3D:true, scale:1,  x:0, ease:easeType})
                  hoverOn = 1;
                } else {
                  TweenMax.to([catCont.element, cat_overlay_color.element],.5, {autoAlpha:0, ease:"Power2.easeOut"});
              ...
              // hit_area.on("mouseover", function(){TweenMax.to(lifestyle_img.element, .5, {force3D:true, /*scale:.98,*/ width:314, height: 128,  x:0, ease:easeType})});
              // hit_area.on("mouseout", function(){TweenMax.to(lifestyle_img.element, .5, {force3D:true,  /*scale:1,*/ width:300, height: 114, x:0, ease:easeType})});

              hit_area.on("mouseover", function(){TweenMax.to(lifestyle_img.element, .5, {force3D:false, scale:1, x:0, ease:easeType})});
              hit_area.on("mouseout", function(){TweenMax.to(lifestyle_img.element, .5, {force3D:false,  scale:.98,  x:0, ease:easeType})});
