...
//
      ...
      function animateElements() {
              ...
              TweenMax.fromTo(lifestyle_img.element,3.5,{force3D:true, preserve3D:true, autoAlpha:0, scale:1.1},{force3D:true, preserve3D:true, scale:.97,  x:0, delay:0, autoAlpha:1,ease:easeType,});
              ...
              function hover(){
                if (hoverOn === 0){
                  ...
                  TweenMax.to(lifestyle_img.element, .5, {force3D:true,  scale:.97, x:0, ease:easeType})
                  hoverOn = 0;
                }
              }
              ...
              hit_area.on("mouseout", function(){TweenMax.to(lifestyle_img.element, .5, {force3D:true,  scale:.97, x:0, ease:easeType})});
