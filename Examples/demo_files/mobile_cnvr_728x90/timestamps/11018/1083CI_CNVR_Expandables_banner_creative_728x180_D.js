...
//F1 OPEN SET POSITIONING/////////////////////////////////////////////////
                ...
                function setPositioning(){
                    ...
                    cta_F1.element.backgroundColor = "#FFFFFF";

                    // TweenMax.set(cta_F1.element,{css:{backgroundColor:"#FFFFFF"}});
...
//EVENTS////////////////////////////////////////////////////////////////////
                ...
                cta_F2_text.on("click", clickOut);

                //hover effects////////////////////////
                expandHit.on("mouseover", hoverOnF1);
                expandHit.on("mouseout", hoverOffF1);
                cta_F2_text.on("mouseover", hoverOnF2);
                cta_F2_text.on("mouseout", hoverOffF2);

                function hoverOnF1(){
                    // console.log("hover on");
                    // cta_F1.color = "#e94f3d";
                    cta_F1.color = "#FFFFFF";
                    cta_F1.backgroundColor="#3170b7";
                }
                function hoverOffF1(){
...
//F1 ANIMATION////////////////////////////////////////////////////////////
                ...
                tlOpen.from(logo.element,.7,{x:-10, opacity:0, ease:"Power2.easeInOut"},0);
                tlOpen.from(cta_F1.element,.8,{opacity:0,  /*width: 400,*/ x:-15, /*ease:"Power2.easeInOut"*/},1);
                ...
                tlF1Copy.staggerFrom(F1_copy,.2,{opacity:0, x:-10, ease:"Power2.easeInOut"},.1);
                tlF1Copy.staggerFrom(F1_copy2,.3,{opacity:0, x:-10, ease:"Power2.easeInOut", delay:.3},0.2);
...
//F1 EXPAND ANIMATION///////////////////////////////////////////////////////
                ...
                function expandCreative(){
                        ...
                        tl.to(collapsedCont.element, .6, {height: 180, ease: "Power2.easeInOut"}, .4);
                        tl.to(videoPlayerCont.element, .85, {height: 160, ease: "Power2.easeInOut"}, .5);
                        tl.to(logo.element, .6, {y: 100, ease: "Power2.easeInOut"}, .4);
                        tl.to(logo.element, .6, {x: 137, ease: "Power1.easeInOut"}, .6);
                        tl.to(cta_F2.element, .8, {width: 140, ease: "Power2.easeInOut"}, .6);
                        tl.to(groupedHeadline.element, 0.6, {autoAlpha: 1}, .8);
                        tl.to([closeHit.element, closeButton.element,expandedBgImage.element],.2,{autoAlpha:1},.4);
...
//F1 COLLAPSE ANIMATION///////////////////////////////////////////////////////
                ...
                function clickOut(e){
                    ...
                    TweenMax.set(cta_F1.element,{autoAlpha:1});
