(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:1042,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:1042, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:1042, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:1042, pointerEvents:"none", parentNode:stage}).render()
            };
...
//
			...
			var allElementsArr = [f1_headline_text, f2_headline_text, cta_text, fg_img, style_img, lifestyle_img, badge_img, bg_img, text_bg_color, bg_color];
...
//CUSTOM
              ...
              if (lifestyle_img.element) {frame_1_in.fromTo(badge_img.element,.5,
                {webkitFilter:"blur(" + blurLifestyleStrt.a + "px)",autoAlpha:0, ease: 'Sine.easeInOut', scale: 1.025, y: 0, transformOrigin: transfrom},
                {webkitFilter:"blur(" + blurLifestyleStop.a + "px)",autoAlpha:1, ease: 'Sine.easeInOut', scale: 1, y: 0, transformOrigin: transfrom},.75);
              };
              if (lifestyle_img.element) {frame_1_in.fromTo(logo_img.element,.5,
                {webkitFilter:"blur(" + blurLifestyleStrt.a + "px)",autoAlpha:0, ease: 'Sine.easeInOut', scale: 1.025, y: 0, transformOrigin: transfrom},
                {webkitFilter:"blur(" + blurLifestyleStop.a + "px)",autoAlpha:1, ease: 'Sine.easeInOut', scale: 1, y: 0, transformOrigin: transfrom},1);
              };
              if (lifestyle_img.element) {frame_1_in.fromTo(lifestyle_img.element,2,
                {webkitFilter:"blur(" + blurLifestyleStrt.a + "px)",autoAlpha:0, ease: 'Sine.easeInOut', scale: 1.025, y: 0, transformOrigin: transfrom},
              ...
              if (lifestyle_img.element) {frame_1_out.to(lifestyle_img.element, 1, {webkitFilter:"blur(" + blurLifestyleStrt.a + "px)", y:220, ease: 'Sine.easeInOut',}, 1.5)};
              if (f1_headline_text.element) {frame_1_out.to(f1_headline_text.element, 1.5, {autoAlpha: 0, ease: 'Sine.easeInOut',webkitFilter:"blur(" + blurLifestyleStrt.a + "px)"}, 1.3)};
              ...
              if (f2_headline_text.element) {frame_1_out.from(f2_headline_text.element, 1.3, {autoAlpha: 0,ease: 'Sine.easeInOut',}, 2)};
              if (cta_text.element) {frame_1_out.from(cta_text.element, 1.3, {autoAlpha: 0, ease: 'Sine.easeInOut', onComplete:activateClick}, 2.5)};
              ...
              //INTERACTION
              hit_area.on("click", adHit);
              hit_area.on("mouseenter", function() {hoverText();});
              hit_area.on("mouseleave", function() {hoverText();});
              ...
              function hoverText(){
                if (mouseEnter === false) {
                  TweenMax.to(f2_headline_text.element,.5, {autoAlpha: .25, ease: 'Sine.easeInOut', scale:1, y:0,transformOrigin:"top center"}, .1)
                  TweenMax.to(cta_text.element, .5, {autoAlpha: 1, ease: 'Sine.easeInOut', y:-5}, .2)
                  mouseEnter = true;
                } else {
                  TweenMax.to(f2_headline_text.element,.5, {autoAlpha: 1, ease: 'Sine.easeInOut', scale:1, y:0,transformOrigin:"top center"}, .1)
                  TweenMax.to(cta_text.element, .5, {autoAlpha: 1, ease: 'Sine.easeInOut', y:0}, .2)
                  mouseEnter = false;
                }
              }
