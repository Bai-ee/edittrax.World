(function() {
  ...
  function Creative(dmo){
    ...
    function createElements(){
      ...
      var borders = {
        l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:1046,  pointerEvents:"none", parentNode:stage}).render(),
        r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:1046, pointerEvents:"none",parentNode:stage}).render(),
        t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:1046, pointerEvents:"none", parentNode:stage}).render(),
        b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:1046, pointerEvents:"none", parentNode:stage}).render()
      };
...
//
      ...
      var allElementsArr = [stageBlock, f1_headline_text, f2_headline_text, cta_text, fg_img, style_img, lifestyle_img, badge_img, bg_img, text_bg_color, bg_color];
...
//CUSTOM
        ...
        if (lifestyle_img.element) {frame_1_out.to(lifestyle_img.element, 1, {webkitFilter:"blur(" + blurLifestyleStrt.a + "px)", y:850, ease: 'Sine.easeInOut',}, 1.5)};
