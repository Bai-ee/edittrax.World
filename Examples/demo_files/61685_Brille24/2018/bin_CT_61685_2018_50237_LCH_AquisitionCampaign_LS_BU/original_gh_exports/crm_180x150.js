    ...
    function Creative(dmo){
        ...
        function createElements(){
			...
			var f2_headline_text = R.create("div").set({
				...
				attr:{
					id: "f2_headline_text",
					textContent: R.create("var").set({name:"f2_headline_text", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value()
				}
			}).render();
            ...
            function animateElements() {
                var frame_1_in = new TimelineMax()
					if(lifestyle_img.element){frame_1_in.from(lifestyle_img.element, 1.3, {autoAlpha: 0, ease: 'Power0.easeNone'}, 0)};
					if(f1_headline_text.element){frame_1_in.from(f1_headline_text.element, 1.3, {autoAlpha: 0, ease: 'Power0.easeNone'}, 0)};
					
				var frame_1_out = new TimelineMax()
					if(lifestyle_img.element){frame_1_out.to(lifestyle_img.element, 1, {autoAlpha: 0, ease: 'Power0.easeNone'}, 5)};
					if(f1_headline_text.element){frame_1_out.to(f1_headline_text.element, 1, {autoAlpha: 0, ease: 'Power0.easeNone'}, 5)};
					
				var frame_2_in = new TimelineMax()
					if(cat1_img.element){frame_2_in.from(cat1_img.element, 1.3, {autoAlpha: 0, ease: 'Power0.easeNone'}, 0)};
					if(cat2_img.element){frame_2_in.from(cat2_img.element, 1.3, {autoAlpha: 0, ease: 'Power0.easeNone'}, 0)};
					if(cat3_img.element){frame_2_in.from(cat3_img.element, 1.3, {autoAlpha: 0, ease: 'Power0.easeNone'}, 0)};
					if(f2_headline_text.element){frame_2_in.from(f2_headline_text.element, 1.3, {autoAlpha: 0, ease: 'Power0.easeNone'}, 0)};
					if(cta_text.element){frame_2_in.from(cta_text.element, 1.3, {autoAlpha: 0, ease: 'Power0.easeNone'}, 0)};
