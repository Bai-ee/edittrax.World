(function() {
    ...
    function Creative(dmo){
        ...
        function init(wrapperID) {
            ...
            req( ['require'].concat(config.bundles.Rosetta), function() {
                ...
                Platform.overwrite({
                    ...
                    placementWidth:Number(dmo.mediaWidth) || 180,
                    placementHeight:Number(dmo.mediaHeight) || 150,
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:513,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:513, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:513, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:513, pointerEvents:"none", parentNode:stage}).render()
            };
			...
			var headline_text = R.create("div").set({
				css:{color:R.create("var").set({name:"headline_text_color", defaultValue:"#000000", dataType:"Color", required:false, exposed:true}).render().value(),fontSize:12,fontFamily:11534,fontStyle:"BookFamily",lineHeight:1.17,letterSpacing:1,textAlign:"center",verticalAlign:"middle",marginTop:0,backgroundColor:R.create("var").set({name:"headline_text_bg_color", defaultValue:"", dataType:"Color", required:false, exposed:true}).render().value(),padding:R.create("var").set({name:"headline_text_padding", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),left:7,top:93,width:166,height:37,zIndex:289,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
			...
			var cta_text = R.create("div").set({
                ...
                fontSize:6,fontFamily:11534,fontStyle:"BookFamily",lineHeight:1.15,letterSpacing:0,textAlign:"center",verticalAlign:"middle",marginTop:0,
                ...
                left:55,top:138,width:70,height:11,zIndex:277,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,pixelDensity:FOF_PIXEL_DENSITY,forceLineHeight:true
				},
				attr:{
            ...
            var cta_text_shape = R.create("div").set({
                css:{left:55,top:136,width:70,height:11,zIndex:275,pointerEvents:"none",cursor:"auto",position:"absolute",backgroundColor:R.create("var").set({name:"cta_text_shape_color", defaultValue:"", dataType:"Color", required:false, exposed:true}).render().value(),borderRadius:0,visibility:"hidden"},
                rosetta:{
                    parentNode:stage
                },
                attr:{
			...
			var bg_color = R.create("div").set({
				css:{left:0,top:0,zIndex:5,width:180,height:150,pointerEvents:"none",cursor:"auto",position:"absolute",backgroundColor:R.create("var").set({name:"bg_color", defaultValue:"", dataType:"Color", required:false, exposed:true}).render().value(),borderRadius:0,visibility:"hidden"},
				rosetta:{
					parentNode:stage
				},
				attr:{
			...
			var fg_img = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"fg_img", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center center",left:0,top:0,width:180,height:150,zIndex:503,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			var style_img = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"style_img", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center center",left:0,top:0,width:180,height:150,zIndex:495,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			var logo_img = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"logo_img", defaultValue:"", dataType:"String", required:true, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center center",left:0,top:0,width:180,height:150,zIndex:238,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			var gradient_img_color = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"gradient_img_color", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center center",left:0,top:0,width:180,height:150,zIndex:122,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			// 	css:{backgroundImage:R.create("var").set({name:"cta_img", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center center",left:0,top:0,width:180,height:150,zIndex:114,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
			// 	rosetta:{
			// 		parentNode:stage,
			...
			var lifestyle_img = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"lifestyle_img", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center top",left:1,top:0,width:180,height:88,zIndex:90,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			var panning_lifestyle_img = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"panning_lifestyle_img", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center top",left:0,top:0,width:215,height:88,zIndex:61,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			var text_box_img = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"text_box_img", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center center",left:0,top:0,width:180,height:150,zIndex:45,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			var bg_img = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"bg_img", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center center",left:0,top:0,width:180,height:150,zIndex:13,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			var allElementsArr = [headline_text,cta_text,cta_text_shape,fg_img,style_img,gradient_img_color,/*cta_img,*/lifestyle_img,panning_lifestyle_img,text_box_img,bg_img,bg_color];
            ...
            function animateElements() {
                ...
                if(has_destination_text_val){
                        ...
                        // TweenMax.to(panning_lifestyle_img.element,6,{x: -35, ease: "Power1.easeInOut", delay:1.2, force3D:true});

                         // PANNING POSITION CUSTOM
                        var viewport_width = 180;
                        var viewport_height = 150;
