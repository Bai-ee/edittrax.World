(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:1207,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:1207, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:1207, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:1207, pointerEvents:"none", parentNode:stage}).render()
            };
			...
			var allElementsArr = [fg_img, style_img, lifestyle_img, lifestyle_pan_img, bg_img, overlay_color, bg_color];
            ...
            function animateElements() {
                var frame_1_in = new TimelineMax()
					...
					if(cta_text.element){frame_1_in.from(cta_text.element, 1.5, {autoAlpha: 0, ease: 'Power0.easeNone'}, 2.25)};
