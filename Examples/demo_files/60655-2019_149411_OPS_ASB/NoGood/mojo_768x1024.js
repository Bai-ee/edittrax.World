(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:760,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:760, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:760, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:760, pointerEvents:"none", parentNode:stage}).render()
            };
			...
			var thumbnails_active = R.create("style").set({
				...
				border: R.create("var").set({name:"tn_active_border", defaultValue:"9px solid #ff8332", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var thumbnails_inactive = R.create("style").set({
				...
				border: R.create("var").set({name:"tn_inactive_border", defaultValue:"9px solid #ffffff", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var allElementsArr = [headline_text, fg_img, style_img, endcard_overlay_img, lifestyle_overlay_img, bg_img, bg_color, thumbNailsContainer, rotatorSlideContainer];
