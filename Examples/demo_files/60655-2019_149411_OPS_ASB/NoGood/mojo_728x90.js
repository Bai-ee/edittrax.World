    ...
    function Creative(dmo){
        ...
        function createElements(){
			...
			var headline_text = R.create("div").set({
				...
				attr:{
					id: "headline_text",
					textContent: R.create("var").set({name:"headline_text", defaultValue:"A storied island (come write your own chapter).", dataType:"String", required:false, exposed:true}).render().value()
				}
			}).render();
			...
			var logo_bg_img = R.create("div").set({
				css:{
					backgroundImage: R.create("var").set({name:"logo_bg_img", defaultValue:"logo_bg_img.png", dataType:"String", required:false, exposed:true}).render().value(),
					backgroundSize: "contain",
					backgroundPosition: "center center",
					left: 0,
					top: 0,
				...
				rosetta:{
					parentNode:stage,
					tint: R.create("var").set({name:"logo_bg_img_tint", defaultValue:"", dataType:"Color", required:false, exposed:true}).render().value()
				},
				attr:{
					id: "logo_bg_img"
				}
			...
			var endcard_overlay_img = R.create("div").set({
				css:{
					backgroundImage: R.create("var").set({name:"endcard_overlay_img", defaultValue:"endcard_overlay_img.png", dataType:"String", required:false, exposed:true}).render().value(),
					backgroundSize: "contain",
					backgroundPosition: "center center",
					left: 0,
					top: 0,
			...
			var lifestyle_overlay_img = R.create("div").set({
				css:{
					backgroundImage: R.create("var").set({name:"lifestyle_overlay_img", defaultValue:"lifestyle_overlay_img.png", dataType:"String", required:false, exposed:true}).render().value(),
					backgroundSize: "contain",
					backgroundPosition: "center center",
					left: 0,
					top: 0,
			...
			var thumbNailsArr = [];
			var catImgVarsArr = [
					R.create("var").set({name:"cat_img1", defaultValue:"http://dtord01web02p.dc.dotomi.net/opslocal/nosync/ct/grasshopper/fpo_image/2.jpg", dataType:"String", required:true, exposed:true}).render().value()
				];
			var catImgsArr = [];
			...
			var thumbnails_active = R.create("style").set({
				...
				border: R.create("var").set({name:"tn_active_border", defaultValue:"3px solid #ff8332", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var thumbnails_inactive = R.create("style").set({
				...
				border: R.create("var").set({name:"tn_inactive_border", defaultValue:"3px solid #ffffff", dataType:"String", required:false, exposed:true}).render().value(),
			...
			function startRotator() {
				...
				thumbNails.controlledBy = [rotatorSlide];
				rotatorSlide.controlledBy = [thumbNails];
			};

			/* [BATCH_LOADING] */
			var requiredArr = [logo_img];
			var allElementsArr = [headline_text, fg_img, style_img, logo_bg_img, endcard_overlay_img, lifestyle_overlay_img, bg_img, bg_color, thumbNailsContainer, rotatorSlideContainer];
			...
			var megaBatch = R.create("batch")
				...
				.render({
					success: function(){
						hideFailed(R.filter.removeParallel(thumbNailsArr,catImgsArr,R.filter.parallel(catImgsArr)));
						displayLoaded([
