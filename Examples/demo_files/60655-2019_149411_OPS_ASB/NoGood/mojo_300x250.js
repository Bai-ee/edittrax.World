    ...
    function Creative(dmo){
        ...
        function createElements(){
			...
			var thumbnails_active = R.create("style").set({
				...
				border: R.create("var").set({name:"tn_active_border", defaultValue:"4px solid #ff8332", dataType:"String", required:false, exposed:true}).render().value(),
			...
			var thumbnails_inactive = R.create("style").set({
				...
				border: R.create("var").set({name:"tn_inactive_border", defaultValue:"4px solid #ffffff", dataType:"String", required:false, exposed:true}).render().value(),
