(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:131,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:131, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:131, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:131, pointerEvents:"none", parentNode:stage}).render()
            };
...
///////////////////////////////////////////////////
			...
			/* [BATCH_LOADING] */
			var allElementsArr = [stageBlock, car_img, map_img,f1_logos_img, fg_img, style_img, f2_bottles_img, f3_copy_img, bg_img, bg_color];
            ...
            function animateElements() {
                ...
                var all_frames = new TimelineMax()
					...
					if(f1_logos_img.element){all_frames.to(f1_logos_img.element, 1, {left: -370}, 1.2)};
					if(map_img.element){all_frames.to(map_img.element, 2, {left: -600}, 1.2)};					
					//turn right
					if(car_img.element){all_frames.to(car_img.element, 0.1, {rotation: 90},1.5)};
					if(car_img.element){all_frames.to(car_img.element, 2.1, {left:-590},1.4)};
					if(car_img.element){all_frames.to(car_img.element, .6, {y:"+135"},1.5)};

					//turn left
					if(f2_bottles_img.element){all_frames.from(f2_bottles_img.element, .8, {left: 300}, 1.7)};
					if(car_img.element){all_frames.to(car_img.element, 0.1, {rotation: 0},2.1)};
					if(car_img.element){all_frames.to(car_img.element, 1.1, {x:"+888"},2.2)};
