        ...
        function createElements(){
            ...
            function animateElements() {
                var all_frames = new TimelineMax()
					if(f1_logos_img.element){all_frames.to(f1_logos_img.element, 1, {left: -300, ease: 'Power2.easeOut'}, 2.5)};
					if(f2_bottles_img.element){all_frames.from(f2_bottles_img.element, 1, {left: 300, ease: 'Power2.easeOut'}, 3)};
					if(f2_bottles_img.element){all_frames.to(f2_bottles_img.element, 1, {left: -300, ease: 'Power2.easeOut'}, 5.5)};
					if(f3_copy_img.element){all_frames.from(f3_copy_img.element, 1, {left: 300, ease: 'Power2.easeOut'}, 6)};
