(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:510,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:510, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:510, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:510, pointerEvents:"none", parentNode:stage}).render()
            };
			...
			var details_text = R.create("div").set({
				css:{color:R.create("var").set({name:"details_text_color", defaultValue:"#000000", dataType:"Color", required:false, exposed:true}).render().value(),fontSize:8,fontFamily:10039,fontStyle:"Medium",lineHeight:1.2,letterSpacing:0,textAlign:"left",verticalAlign:"middle",marginTop:0,backgroundColor:R.create("var").set({name:"details_text_bg_color", defaultValue:"", dataType:"Color", required:false, exposed:true}).render().value(),padding:R.create("var").set({name:"details_text_padding", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),left:8,top:236,width:63,height:11,zIndex:293,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
			...
			var destination_text = R.create("div").set({
				css:{color:R.create("var").set({name:"destination_text_color", defaultValue:"#000000", dataType:"Color", required:false, exposed:true}).render().value(),fontSize:11,fontFamily:11534,fontStyle:"BookFamily",lineHeight:1.25,letterSpacing:1,textAlign:"center",verticalAlign:"middle",marginTop:0,backgroundColor:R.create("var").set({name:"destination_text_bg_color", defaultValue:"", dataType:"Color", required:false, exposed:true}).render().value(),padding:R.create("var").set({name:"destination_text_padding", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),left:9,top:140,width:281,height:17,zIndex:283,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,pixelDensity:FOF_PIXEL_DENSITY,forceLineHeight:true
				},
				attr:{
			...
			var cta_text = R.create("div").set({
                ...
                fontSize:9,fontFamily:11534,fontStyle:"BookFamily",lineHeight:1.23,letterSpacing:0,textAlign:"center",verticalAlign:"middle",marginTop:0,
                ...
                left:196,top:230,width:99,height:18,zIndex:278,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,pixelDensity:FOF_PIXEL_DENSITY,forceLineHeight:true
				},
				attr:{
            ...
            var cta_text_shape = R.create("div").set({
                css:{left:196,top:228,width:99,height:18,zIndex:276,pointerEvents:"none",cursor:"auto",position:"absolute",backgroundColor:R.create("var").set({name:"cta_text_shape_color", defaultValue:"", dataType:"Color", required:false, exposed:true}).render().value(),borderRadius:0,visibility:"hidden"},
                rosetta:{
                    parentNode:stage
                },
                attr:{
            ...
            var text_container = R.create("div").set({
                css:{
                marginTop: 137,left:0,top:0,width:300,height:90,zIndex:265,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
                rosetta:{
                    parentNode:stage,pixelDensity:FOF_PIXEL_DENSITY,forceLineHeight:true
                },
                attr:{
			...
			var headline_text = R.create("div").set({
                ...
                fontSize:16,fontFamily:11534,fontStyle:"BookFamily",lineHeight:0.99,letterSpacing:1,textAlign:"center",verticalAlign:"middle",
                ...
                /*marginTop: 137,*/left:10,top:38,width:281,height:34,zIndex:265,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
			...
			var subhead_text = R.create("div").set({
                ...
                fontSize:9,fontFamily:10039,fontStyle:"Medium",lineHeight:1.19,letterSpacing:1,textAlign:"center",verticalAlign:"middle",marginTop:3,
                ...
                left:9,top:65,width:281,height:20,zIndex:264,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:text_container,pixelDensity:FOF_PIXEL_DENSITY,forceLineHeight:true
				},
				attr:{
			...
			var bg_color = R.create("div").set({
				css:{left:0,top:0,zIndex:2,width:300,height:250,pointerEvents:"none",cursor:"auto",position:"absolute",backgroundColor:R.create("var").set({name:"bg_color", defaultValue:"", dataType:"Color", required:false, exposed:true}).render().value(),borderRadius:0,visibility:"hidden"},
				rosetta:{
					parentNode:stage
				},
				attr:{
			...
			var fg_img = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"fg_img", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center center",left:0,top:0,width:300,height:250,zIndex:500,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			var style_img = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"style_img", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center center",left:0,top:0,width:300,height:250,zIndex:492,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			var logo_img = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"logo_img", defaultValue:"", dataType:"String", required:true, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center center",left:0,top:0,width:300,height:250,zIndex:239,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			var gradient_img_color = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"gradient_img_color", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center center",left:0,top:0,width:300,height:250,zIndex:123,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			// 	css:{backgroundImage:R.create("var").set({name:"cta_img", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center center",left:0,top:0,width:300,height:250,zIndex:115,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
			// 	rosetta:{
			// 		parentNode:stage,
			...
			var badge_img = R.create("div").set({
				css:{backgroundImage:badge_img_val,backgroundSize:"contain",backgroundPosition:"center center",left:0,top:0,width:300,height:250,zIndex:109,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			var lifestyle_img = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"lifestyle_img", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center top",left:0,top:1,width:300,height:137,zIndex:94,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			var panning_lifestyle_img = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"panning_lifestyle_img", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center top",left:0,top:0,width:350,height:136,zIndex:65,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			var text_box_img = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"text_box_img", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center center",left:0,top:0,width:300,height:250,zIndex:46,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			var bg_img = R.create("div").set({
				css:{backgroundImage:R.create("var").set({name:"bg_img", defaultValue:"", dataType:"String", required:false, exposed:true}).render().value(),backgroundSize:"contain",backgroundPosition:"center center",left:0,top:0,width:300,height:250,zIndex:10,pointerEvents:"none",cursor:"auto",position:"absolute",visibility:"hidden"},
				rosetta:{
					parentNode:stage,
			...
			var Group2Array = [headline_text,subhead_text];
            ...
            function animateElements() {
                ...
                if(has_destination_text_val && has_badge_img_val){
                    ...
                    // TweenMax.to(panning_lifestyle_img.element,6,{x: -50, ease: "Power1.easeInOut", delay:1.2, force3D:true});

                    // PANNING POSITION CUSTOM
                var viewport_width = 300;
                var viewport_height = 250;
                TweenMax.set(panning_lifestyle_img.element, {left:0, x:0, y:0});
                if (lifestyle_img != undefined) {
                ...
                console.log("lifestyle_img.style.width " + panning_lifestyle_img.style.width);
