(function() {
    ...
    function Creative(dmo){
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:1208,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:1208, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:1208, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:1208, pointerEvents:"none", parentNode:stage}).render()
            };
			...
			var line_right_color = R.create("div").set({
				css:{
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"line_right_color", defaultValue:"#ffffff", dataType:"Color", required:false, exposed:true}).render().value(),
					borderRadius: 0,
					visibility: "hidden"
				},
				rosetta:{
			...
			var line_left_color = R.create("div").set({
				css:{
					...
					cursor: "auto",
					position: "absolute",
					backgroundColor: R.create("var").set({name:"line_left_color", defaultValue:"#ffffff", dataType:"Color", required:false, exposed:true}).render().value(),
					borderRadius: 0,
					visibility: "hidden"
				},
				rosetta:{
            ...
            function animateElements() {
                var frame_1_in = new TimelineMax()
					...
					if(badge_img.element){frame_1_in.from(badge_img.element, 1.5, {autoAlpha: 0, ease: 'Power1.easeOut'}, 2.25)};
					if(headline_text.element){frame_1_in.from(headline_text.element, 1.5, {autoAlpha: 0, ease: 'Power1.easeOut'}, 2)};
					if(cta_text.element){frame_1_in.from(cta_text.element, 1.5, {autoAlpha: 0, ease: 'Power1.easeOut'}, 2.25)};
					if(line_right_color.element){frame_1_in.from(line_right_color.element, 1.5, {autoAlpha: 0, ease: 'Power1.easeOut'}, 2.25)};
					if(line_left_color.element){frame_1_in.from(line_left_color.element, 1.5, {autoAlpha: 0, ease: 'Power1.easeOut'}, 2.25)};
