...
//COLLAPSED STATE////////////////////////////////////
            ...
            var logo = R.create('div').set({
                css: {
                    width: 300,
                    height: 600,
                    backgroundImage: 'logo_img_expanded.png',
                ...
                attr:{
                    id:"videoPlayerCont"
                        ...
                        var vidPlayer = R.create("default_video_player").set({
                            ...
                            analyticsName:"1083CI_CNVR_expandable_300x600",
                            position:"absolute",
                            // display:"none",
...
//F1 OPEN SET POSITIONING/////////////////////////////////////////////////
                ...
                function setPositioning(){
                    ...
                    TweenMax.set(logo.element, {scale:.6});
...
//F1 EXPAND ANIMATION///////////////////////////////////////////////////////
                ...
                function expandCreative(){
                        ...
                        tl.to(videoPlayerCont.element, .85, {width:300, ease: "Power1.easeInOut"}, .5);

                        tl.to(logo.element, .6, {y: -33, x: -104, scale:.77, ease: "Power2.easeInOut"}, .4);
                        // tl.to(logo.element, .6, {scale:.77, ease: "Power1.easeInOut"}, .6);
                        // tl.to(cta_F2_text.element, .6, {y:0, ease: "Power2.easeInOut"}, .4);
                        // tl.to(cta_F2_text.element, .6, {x: 135, y:22,  ease: "Power1.easeInOut"}, .6);

                        tl.to(cta_F2.element, 1.7, {height: 500, ease: "Power4.easeInOut"},.1);
...
//F1 COLLAPSE ANIMATION///////////////////////////////////////////////////////
                ...
                function clickOut(e){
                    ...
                    TweenMax.set(logo.element, {scale:.6});
                    TweenMax.set(collapsedCont.element, {width: 160});
