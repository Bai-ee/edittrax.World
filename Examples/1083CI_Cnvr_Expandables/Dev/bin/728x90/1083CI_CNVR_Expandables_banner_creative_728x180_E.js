                ...
                attr:{
                    id:"videoPlayerCont"
                        ...
                        var vidPlayer = R.create("default_video_player").set({
                            ...
                            analyticsName:"1083CI_CNVR_expandable_728x180"
                        }).render({
                            success:function(){
                                log("video loaded")
...
//F1 EXPAND ANIMATION///////////////////////////////////////////////////////
                ...
                function expandCreative(){
                        ...
                        // tl.to(cta_F2_text.element, .6, {y:150, ease: "Power2.easeInOut"}, .4);
                        // tl.to(cta_F2_text.element, .6, {x: 124.5, y:22,  ease: "Power1.easeInOut"}, .6);
                        tl.to(cta_F2.element, 1, {width: 140, ease: "Power2.easeInOut"}, .4);
                        tl.to(groupedHeadline.element, 0.7, {autoAlpha: 1}, .8);
