        ...
        function init(wrapperID) {
            ...
            req( ['require'].concat(config.bundles.Rosetta), function() {
                ...
                Platform.overwrite({
                    ...
                    placementWidth:Number(dmo.mediaWidth) || 560,
...
//COLLAPSED STATE////////////////////////////////////
            ...
            var logo = R.create('div').set({
                css: {
                    width: 300,
                    height: 600,
                    backgroundImage: 'logo_img_F1.png',
...
//F1 EXPAND ANIMATION///////////////////////////////////////////////////////
                ...
                function expandCreative(){
                        ...
                        tl.to(videoPlayerCont.element, .85, {width:499, ease: "Power1.easeInOut"}, .5);

                        tl.to(logo.element, .6, {y: 53, ease: "Power2.easeInOut"}, .4);
                        tl.to(logo.element, .6, {x: 0, ease: "Power1.easeInOut"}, .6);
                        // tl.to(cta_F2_text.element, .6, {y:0, ease: "Power2.easeInOut"}, .4);
                        // tl.to(cta_F2_text.element, .6, {x: 135, y:22,  ease: "Power1.easeInOut"}, .6);

                        tl.to(cta_F2.element, 1.2, {height: 600, ease: "Power4.easeInOut"},.1);
