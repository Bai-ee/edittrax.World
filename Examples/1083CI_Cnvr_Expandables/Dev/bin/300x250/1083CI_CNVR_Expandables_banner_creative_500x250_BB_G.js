        ...
        function init(wrapperID) {
            ...
            req( ['require'].concat(config.bundles.Rosetta), function() {
                ...
                Platform.overwrite({
                    ...
                    placementWidth:Number(dmo.mediaWidth) || 500,
...
//COLLAPSED STATE////////////////////////////////////
            ...
            var logo = R.create('div').set({
                css: {
                    width: 300,
                    height: 250,
                    backgroundImage: 'logo_img_contracted_f1.png',
                ...
                attr:{
                    id:"videoPlayerCont"
                        ...
                        var vidPlayer = R.create("default_video_player").set({
                            ...
                            analyticsName:"1083CI_CNVR_expandable_500x250",
                            position:"absolute",
                            // display:"none",
...
setPositioning();
                ...
                function setPositioning(){
                    ...
                    TweenMax.set([stage.element, collapsedCont.element],{height:250, pointerEvents:"none"});
...
//F1 EXPAND ANIMATION///////////////////////////////////////////////////////
                ...
                function expandCreative(){
                        ...
                        tl.to([stage.elemnt, collapsedCont.element], .6, {width: 560, ease: "Power2.easeInOut"}, .4);

                        tl.to(videoPlayerCont.element, .85, {width:291, ease: "Power1.easeInOut"}, .5);

                        tl.to(logo.element, .6, {y: 15, ease: "Power2.easeInOut"}, .6);
                        tl.to(logo.element, .6, {x: -328, ease: "Power1.easeInOut"}, .4);
                        // tl.to(cta_F2_text.element, .6, {y:0, ease: "Power2.easeInOut"}, .4);
                        // tl.to(cta_F2_text.element, .6, {x: 135, y:22,  ease: "Power1.easeInOut"}, .6);

                        tl.to(cta_F2.element, 1.2, {width: 300, ease: "Power4.easeInOut"},.1);
...
//F1 COLLAPSE ANIMATION///////////////////////////////////////////////////////
                ...
                function clickOut(e){
                    ...
                    // TweenMax.set(collapsedCont.element, {width: 300});
