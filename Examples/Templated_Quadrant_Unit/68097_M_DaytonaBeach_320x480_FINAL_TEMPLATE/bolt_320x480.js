...
(function() {
    ...
    function Creative(dmo){
        ...
        function init(wrapperID) {
            var subdirectory = "68097M_BR_INA";
...
/////////////////////////////   
                        ...
                        /* [CREATING_COMPONENTS] */
                        var catImgVarsArr = [
                                        R.create("var").set({name:"cat_img1", defaultValue:"cat_img1.jpg", dataType:"String", required:true, exposed:true}).render().value(),
                                        R.create("var").set({name:"cat_img2", defaultValue:"cat_img2.jpg", dataType:"String", required:false, exposed:true}).render().value(),
                                        R.create("var").set({name:"cat_img3", defaultValue:"cat_img3.jpg", dataType:"String", required:false, exposed:true}).render().value(),
                                        R.create("var").set({name:"cat_img4", defaultValue:"cat_img4.jpg", dataType:"String", required:false, exposed:true}).render().value()
                                ];
                        var catImgsArr = [];
                        var catImgUrlArr = [];
            ...
            function animateElements() {
                ...
                rotatorSlide.transitionDuration = 0
                                ...
                                // console.log("success")
                                TweenMax.to(rotatorSlide.element, .5, {opacity:0, onComplete:turnOnPointerEvents()})
                                frame_1_out.reverse()
                                                openingAnimation();
                                TweenMax.set(back_img.element, {autoAlpha:0});
