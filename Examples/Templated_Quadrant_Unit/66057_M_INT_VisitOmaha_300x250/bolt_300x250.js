(function() {
    ...
    function Creative(dmo){
        ...
        function init(wrapperID) {
            ...
            var creativeName = "Visit_Omaha_Mobile_Unit_Emerging_300x250" || subdirectory;
            var companyID = "80258";
        ...
        function createElements(){
            ...
            var borders = {
                l:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, left:0, top:0, zIndex:395,  pointerEvents:"none", parentNode:stage}).render(),
                r:R.create("div").set({width:"1px", height:height, backgroundColor:borderColor, right:0, top:0, zIndex:395, pointerEvents:"none",parentNode:stage}).render(),
                t:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, top:0, zIndex:395, pointerEvents:"none", parentNode:stage}).render(),
                b:R.create("div").set({width:width, height:"1px", backgroundColor:borderColor, left:0, bottom:0, zIndex:395, pointerEvents:"none", parentNode:stage}).render()
            };
            ...
            R.applyCSSReset(".stage");
                ...
                //Give duplicated iterations of this creative a unique tracking name (optional)

                /* Udate landingPage var with your required clickOut URL (if your LP is a clickTracker uncomment Math.floor) */
                var landingPage = "https://www.conversantmedia.com" /*+ Math.floor(Math.random() * 100000000000)*/;
                var redirectUrl = (clickTracker) ? clickTracker + encodeURIComponent(landingPage) : landingPage;

                /* If more than 1 unique clickOut is required uncomment lines 23 and 25 */
                // var landingPage2 = "http://www.conversantmedia.com/" /*+ Math.floor(Math.random() * 100000000000)*/;
                /* Update the url property for each element that needs a unique clickOut */
                // var redirectUrl2 = (clickTracker) ? clickTracker + encodeURIComponent(landingPage2) : landingPage2;

                /* If more than 2 unique clickOuts are required, copy paste lines 23 and 25 below, iterate all var names */
                        ...
                        var icon1_img = R.create("div").set({
                                ...
                                rosetta:{
                                        parentNode:stage,
                                        tint: R.create("var").set({name:"icon1_img_tint", defaultValue:"FF0000", dataType:"Color", required:false, exposed:true}).render().value()
                                },
                                attr:{
                                        id: "icon1_img"
                                }
                        ...
                        var icon2_img = R.create("div").set({
                                ...
                                rosetta:{
                                        parentNode:stage,
                                        tint: R.create("var").set({name:"icon2_img_tint", defaultValue:"FF0000", dataType:"Color", required:false, exposed:true}).render().value()
                                },
                                attr:{
                                        id: "icon2_img"
                                }
                        ...
                        var icon3_img = R.create("div").set({
                                ...
                                rosetta:{
                                        parentNode:stage,
                                        tint: R.create("var").set({name:"icon3_img_tint", defaultValue:"FF0000", dataType:"Color", required:false, exposed:true}).render().value()
                                },
                                attr:{
                                        id: "icon3_img"
                                }
                        ...
                        var icon4_img = R.create("div").set({
                                ...
                                rosetta:{
                                        parentNode:stage,
                                        tint: R.create("var").set({name:"icon4_img_tint", defaultValue:"FF0000", dataType:"Color", required:false, exposed:true}).render().value()
                                },
                                attr:{
                                        id: "icon4_img"
                                }
                ...
                var redirectUrl = (clickTracker) ? clickTracker + encodeURIComponent(landingPage) : landingPage;
                        ...
                        /* [CREATING_COMPONENTS] */
                        var catImgVarsArr = [
                                        R.create("var").set({name:"cat_img1", defaultValue:"frame_1_20200109.jpg", dataType:"String", required:true, exposed:true}).render().value(),
                                        R.create("var").set({name:"cat_img2", defaultValue:"frame_2_20200109.jpg", dataType:"String", required:false, exposed:true}).render().value(),
                                        R.create("var").set({name:"cat_img3", defaultValue:"frame_3_20200109.jpg", dataType:"String", required:false, exposed:true}).render().value(),
                                        R.create("var").set({name:"cat_img4", defaultValue:"frame_4_20200109.jpg", dataType:"String", required:false, exposed:true}).render().value()
                                ];
                        var catImgsArr = [];
                        var catImgUrlArr = [];
                        ...
                        var allElementsArr = [indicator_img2, indicator_img3, indicator_img4, fg_img, style_img, headline_img, icon1_img, icon1_text_img, icon2_img, icon2_text_img, icon3_img, icon3_text_img, icon4_img, icon4_text_img, indicator_img, lifestyle_img, back_img, bg_img, bg_color, nDotsContainer, rotatorSlideContainer];
...
if ("maxTouchPoints" in navigator) { 
    hasTouchScreen = navigator.maxTouchPoints > 0;
            // console.log("Hitting 1 if")
} else if ("msMaxTouchPoints" in navigator) {
    hasTouchScreen = navigator.msMaxTouchPoints > 0; 
            // console.log("Hitting else if 1 ")
} else {
    ...
    if (mQ && mQ.media === "(pointer:coarse)") {
        ...
        // console.log(hasTouchScreen + "THIS IS touchscreen")
                 ...
                 TweenMax.set(indicator_img.element, {scale:0, autoAlpha:0})
                 TweenMax.set(indicator_img4.element, {scale:0, autoAlpha:0})
                 TweenMax.set(indicator_img2.element, {scale:0, autoAlpha:0})
                 TweenMax.set(indicator_img3.element, {scale:0,autoAlpha:0})
                ...
                function openingAnimation(){
                        ...
                        var frame_1_in = new TimelineMax()
                                                ...
                                                if(icon1_img.element){frame_1_in.set(rotatorSlideContainer.element, {autoAlpha: 0}, 0)};
                                                ...
                                                if(icon1_img.element){frame_1_in.from(icon1_img.element, .5, {scale:0, autoAlpha: 0, ease: 'Power1.easeIn'}, .4)};
                                                 if(icon2_text_img.element){frame_1_in.from(icon1_text_img.element, 1, {autoAlpha: 0, ease: 'Power1.easeIn'}, 0.6)};
                ...
                Analytics.fire({event: "click", currentInstance:{analyticsName: "Quadrant" + num}});
                TweenMax.set(rotatorSlideContainer.element, {autoAlpha:1})

                TweenMax.to(logo_img.element, .25, {autoAlpha:0, delay:.15});
                TweenMax.set(back_img.element, {autoAlpha:1, delay:.25});               
                ...
                rotatorSlide.transitionDuration = 0
                                 ...
                                 var tl = new TimelineMax()
                                        ...
                                        function reset(){
                                TweenMax.set(logo_img.element, {autoAlpha:1});
                                // console.log("success")
                ...
                function clickToRotator1(){
                        console.log("hit")
                         TweenMax.to(indicator_img.element, .2, {scale:1, autoAlpha: 1, ease: 'Power4.easeOut'});
                                         TweenMax.to(indicator_img.element, .4, {scale:0, autoAlpha: 0, ease: 'Power4.easeIn', delay:.2, onComplete:clickToRotator(1)});
                ...
                function clickToRotator2(){
                         TweenMax.to(indicator_img2.element, .2, {scale:1, autoAlpha: 1, ease: 'Power4.easeOut'});
                                         TweenMax.to(indicator_img2.element, .4, {scale:0, autoAlpha: 0, ease: 'Power4.easeIn', delay:.2, onComplete:clickToRotator(2)});
                ...
                function clickToRotator3(){
                         TweenMax.to(indicator_img3.element, .2, {scale:1, autoAlpha: 1, ease: 'Power4.easeOut'});
                                         TweenMax.to(indicator_img3.element, .4, {scale:0, autoAlpha: 0, ease: 'Power4.easeIn', delay:.2, onComplete:clickToRotator(3)});
                ...
                function clickToRotator4(){
                         TweenMax.to(indicator_img4.element, .2, {scale:1, autoAlpha: 1, ease: 'Power4.easeOut'});
                                         TweenMax.to(indicator_img4.element, .4, {scale:0, autoAlpha: 0, ease: 'Power4.easeIn', delay:.2, onComplete:clickToRotator(4)});
